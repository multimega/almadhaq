...
class WithdrawController extends Controller
{
  	...
  	public function index_34()
    {
        $withdraws = Withdraw::where('user_id','=',Auth::guard('web')->user()->id)->where('type','=','user')->orderBy('id','desc')->get();
        $sign = Currency::where('is_default','=',1)->first();        
        return view('user.withdraw.index_34',compact('withdraws','sign'));
    }
    ...
    public function affilate_code_34()
    {
        $user = Auth::guard('web')->user();
        return view('user.withdraw.affilate_code_34',compact('user'));
    }
    ...
    public function create_34()
    {
        $sign = Currency::where('is_default','=',1)->first();
        return view('user.withdraw.withdraw_34' ,compact('sign'));
    }
