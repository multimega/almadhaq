   ...
   public function __construct()
    ...
    public function datatables()
    {
         ...
         return Datatables::of($datas)
                            ->addColumn('action', function(Currency $data) {
                                ...
                                return '<div class="action-list"><a data-href="' . route('admin-currency-edit',$data->id) . '" class="edit" data-bs-toggle="modal" data-bs-target="#modal1"> <i class="fas fa-edit"></i>Edit</a>'.$delete.$default.'</div>';
                            }) 
                            ...
                            ->editColumn('image',function($row){
                                ...
                                return '<img src="'.asset('/assets/images/currency/'.$row->image).'">';
    ...
    public function store(Request $request)
    {
        ...
        $rules = [
            ...
            'image' => 'mimes:jpeg,jpg,png,gif,svg,webp|required|max:10000'
            ];
