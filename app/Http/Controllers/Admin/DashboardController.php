...
class DashboardController extends Controller
{
    ...
    public function lang_settings(){
        return view('admin.lang-settings');
    }
    public function mobile_settings(){
        return view('admin.mobile-settings');
    }
    public function shipment_settings(){
        return view('admin.shipment-settings');
    }
    ...
    public function marketing_kit(){
        return view('admin.marketing-kit');
    }
    public function coupons(){
        return view('admin.coupons');
    }
    public function support_manager(){
        return view('admin.support-manager');
    }
    
    
    public function index()
    {
        $pending = Order::where('status','=','pending')->where('order_completed',1)->get();
