	    ...
	    public function datatables()
	    {
	         ...
	         return Datatables::of($datas)
	                            ...
	                            ->addColumn('action', function(Rating $data) {
	                                return '<div class="action-list-radius"><a data-href="' . route('admin-rating-show',$data->id) . '" class="main-bg-dark me-2" data-bs-toggle="modal" data-bs-target="#modal1"> <i class="fas fa-eye me-1"></i>Details</a><a href="javascript:;" data-href="' . route('admin-rating-delete',$data->id) . '" data-bs-toggle="modal" data-bs-target="#confirm-delete" class="delete bg-danger text-white"><i class="fas fa-trash-alt"></i></a></div>';
	                            }) 
