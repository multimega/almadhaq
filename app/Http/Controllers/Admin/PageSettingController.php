...
class PageSettingController extends Controller
{
    ...
    protected $customs =
    [
        'best_seller_banner.mimes'  => 'Photo type must be in jpeg, jpg, png, svg , webp.',
        'big_save_banner.mimes'     => 'Photo type must be in jpeg, jpg, png, svg , webp.',
        'best_seller_banner1.mimes' => 'Photo type must be in jpeg, jpg, png, svg , webp.',
        'big_save_banner1.mimes'    => 'Photo type must be in jpeg, jpg, png, svg , webp.'
