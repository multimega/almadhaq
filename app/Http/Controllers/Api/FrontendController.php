...
class FrontendController extends Controller{
		...
		public function Product($id)
	{
	   // dd(Auth::guard('api')->user());
        $products =  Product::with(['category' => function($query){$query->select('id', 'photo');}])->with(['user'=>function($query){$query->select('id','name');}])->with(['brand'=>function($query){$query->select('id','name');}])->with(['ratings'=>function($query){$query->select('created_at','review','rating');}])->with(['mobilegalleries'=>function($query){$query->select('id','photo');}])->where('id','=',$id)->first();
	...
	{
        $products =  Product::with(['category' => function($query){$query->select('id', 'photo');}])->with(['user'=>function($query){$query->select('id','name');}])->with(['brand'=>function($query){$query->select('id','name');}])->with(['ratings'=>function($query){$query->select('review','rating');}])->with(['mobilegalleries'=>function($query){$query->select('id','photo');}])->where('brand_id','=',$id)->orderBy('id','desc')->get();
	...
	{
       $products =  Product::with(['category' => function($query){$query->select('id', 'photo');}])->with(['user'=>function($query){$query->select('id','name');}])->with(['brand'=>function($query){$query->select('id','name');}])->with(['ratings'=>function($query){$query->select('review','rating');}])->with(['mobilegalleries'=>function($query){$query->select('id','photo');}])->where('hot','=',1)->where('status','=',1)->orderBy('id','desc')->take(10)->get();
	...
	public function ProductBest()
	{
           ...
           $products =  Product::with(['category' => function($query){$query->select('id', 'photo');}])->with(['user'=>function($query){$query->select('id','name');}])->with(['brand'=>function($query){$query->select('id','name');}])->with(['ratings'=>function($query){$query->select('review','rating');}])->with(['mobilegalleries'=>function($query){$query->select('id','photo');}])->where('best','=',1)->where('status','=',1)->orderBy('id','desc')->take(10)->get();
  ...
  if($product->previous_price){
	    ...
	    public function LatestProduct(Request $request)
	{
      ...
      $latest_products =  Product::with(['category' => function($query){$query->select('id', 'photo');}])->with(['user'=>function($query){$query->select('id','name');}])->with(['brand'=>function($query){$query->select('id','name');}])->with(['ratings'=>function($query){$query->select('review','rating');}])->with(['mobilegalleries'=>function($query){$query->select('id','photo');}])->where('latest','=',1)->where('status','=',1)->orderBy('id','desc')->take(10)->get();
	...
	public function TrendingProduct()
	{
        ...
        // $trending_products =  Product::where('trending','=',1)->where('status','=',1)->orderBy('id','desc')->take(9)->get();
              ...
              $trending_products =  Product::with(['category' => function($query){$query->select('id', 'photo');}])->with(['user'=>function($query){$query->select('id','name');}])->with(['brand'=>function($query){$query->select('id','name');}])->with(['ratings'=>function($query){$query->select('review','rating');}])->with(['mobilegalleries'=>function($query){$query->select('id','photo');}])->where('trending','=',1)->where('status','=',1)->orderBy('id','desc')->take(10)->get();
	...
	public function SaleProduct()
	{
      ...
      $latest_products =  Product::with(['category' => function($query){$query->select('id', 'photo');}])->with(['user'=>function($query){$query->select('id','name');}])->with(['brand'=>function($query){$query->select('id','name');}])->with(['ratings'=>function($query){$query->select('review','rating');}])->with(['mobilegalleries'=>function($query){$query->select('id','photo');}])->where('sale','=',1)->where('status','=',1)->orderBy('id','desc')->take(10)->get();
	...
	{
      $latest_products =  Product::with(['category' => function($query){$query->select('id', 'photo');}])->with(['user'=>function($query){$query->select('id','name');}])->with(['brand'=>function($query){$query->select('id','name');}])->with(['ratings'=>function($query){$query->select('review','rating');}])->with(['mobilegalleries'=>function($query){$query->select('id','photo');}])->where('category_id','=',$id)->where('status','=',1)->orderBy('id','desc')->get();
 ...
 $product['mobile_price']  = number_format($product->mobile_price * $currency['value'],2);
  if($product->previous_price){
	...
	{
        $products =  Product::with(['category' => function($query){$query->select('id', 'name','name_ar','photo');}])->with(['user'=>function($query){$query->select('id','name');}])->with(['brand'=>function($query){$query->select('id','name');}])->with(['ratings'=>function($query){$query->select('review','rating');}])->with(['mobilegalleries'=>function($query){$query->select('id','photo');}])->where('subcategory_id','=',$id)->where('status',1)->orderBy('id','desc')->get();
        foreach($products as $k => $product){
	...
	{
        $products =  Product::with(['category' => function($query){$query->select('id','name','name_ar', 'photo');}])->with(['subcategory' => function($query){$query->select('id','name','name_ar', 'photo');}])->with(['user'=>function($query){$query->select('id','name');}])->with(['brand'=>function($query){$query->select('id','name');}])->with(['ratings'=>function($query){$query->select('review','rating');}])->with(['mobilegalleries'=>function($query){$query->select('id','photo');}])->where('childcategory_id','=',$id)->where('status',1)->orderBy('id','desc')->get();
        foreach($products as $k => $product){
 ...
 public function brandss(Request $request)
    ...
    if(Auth::guard('api')->user()){
     $currency = Currency::find(Auth::guard('api')->user()->currency);
      ...
      foreach($subcategories as $k => $sub){
         ...
         $subcategories[$k]['product'] =  Product::with(['category' => function($query){$query->select('id', 'photo');}])->with(['user'=>function($query){$query->select('id','name');}])->with(['brand'=>function($query){$query->select('id','name');}])->with(['ratings'=>function($query){$query->select('review','rating');}])->with(['mobilegalleries'=>function($query){$query->select('id','photo');}])->where('subcategory_id','=',$sub->id)->orderBy('id','desc')->get();
    ...
    public function getProductBysubCategory(Request $request) {
      $subcategories = Subcategory::where('id',  $request->subcategory_id)->first();
        ...
        $productsall =  $products =  Product::with(['category' => function($query){$query->select('id', 'photo');}])->with(['user'=>function($query){$query->select('id','name');}])->with(['brand'=>function($query){$query->select('id','name');}])->with(['ratings'=>function($query){$query->select('review','rating');}])->with(['mobilegalleries'=>function($query){$query->select('id','photo');}])->where('subcategory_id','=',$subcategories->id)->where('status',1)->orderBy('id','desc')->get();
