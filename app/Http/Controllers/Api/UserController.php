    ...
    public function phoneregister(Request $request)
        {
          ...
          $validator = Validator::make($request->all(), [
            ...
            'email.unique' => 'email already taked',
   ...
   public function phonelogin(){
       ...
       if(is_numeric(request('phone'))){
            ...
            return response()->json(['error'=>'Unauthorised'], 401);
              ...
              if(Auth::attempt(['email' => request('phone'), 'password' => request('password'), 'status' => 0])){
            $user = Auth::user();
            $success['token'] =  $user->createToken('MyApp')->accessToken;
            $success['id'] =  $user->id;
            $success['name'] =  $user->name;
  ...
  public function forgot(Request $request)
    {
      ...
      return response()->json(array('status' =>'true',  'message'=>'Your Password Reseted Successfully. Please Check your email for new Password.'));
      }
      else{
      // user not found
