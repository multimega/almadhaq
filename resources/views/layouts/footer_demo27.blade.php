...
<style>
    .footer-bottom p + div:first-of-type{
        ...
        <div class="bg-white">
            <div class="container">
                <section class="widget-newsletter mt-5">
                    <i class="Vowalaa-icon-envolope"></i>
                    <h2>{{$gs->popup_title}}</h2>
                    <span>{{$gs->popup_text}}</span>
                        ...
                        <div class="col-xl-5">
                            ...
                            <div class="contact">
                                <div class="contact-widget">
                                    <h4 class="widget-title">{{ $langg->lang951 }}</h4>
...
?>	
    ...
    <a id="scroll-top" href="#top" title="Top" role="button"><i class="fas fa-long-arrow-alt-up"></i></a>
    <!-- Plugins JS File -->
    ...
    <!-- Plugins JS File -->
    <script src="{{asset('assets/demo_27/assets/js/jquery.min.js')}}"></script>
    <script src="{{asset('assets/demo_27/assets/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('assets/demo_27/assets/js/plugins.min.js')}}"></script>
    <script src="{{asset('assets/demo_27/assets/js/jquery.countdown/jquery.countdown.min.js')}}"></script>

    <!-- Main JS File -->
    <script src="{{asset('assets/demo_27/assets/js/main_init.min.js')}}"></script>
    <script src="{{asset('assets/demo_27/assets/js/main.js')}}"></script>
