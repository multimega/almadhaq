 ...
 <footer class="footer">
            <div class="footer-top">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3">
                            <a href="#" class="widget-newsletter-title">{{$gs->popup_title}}</a>
                        </div>
                        <div class="col-lg-4">
                            <p class="widget-newsletter-content">{{$gs->popup_title}}<br>
                                <span class="widget-newsletter-content">{{$gs->popup_text}}</span>
                            </p>
                        </div>
                        <div class="col-lg-5">
                ...
                <div class="footer-middle   ">
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <a href="index.html">
                                <img src="{{asset('assets/images/'.$gs->logo)}}" alt="Vowalaa Logo" class="mt-2">
                            </a>
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-xl-6">
                                    <div class="contact-widget email">
                                        <h4 class="widget-title" style="margin-bottom : .5rem;">{{$langg->lang209}}</h4>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="widget">
                                        <h4 class="widget-title">{{ $langg->lang14 }}</h4>
                                        <ul class="links">
                                        ...
                                        <ul class="links">
                                            @foreach(DB::table('pages')->where('header','=',1)->get() as $data)
							     	             <li><a href="{{ route('front.page',['slug' => $data->slug , 'lang' => $sign ]) }}">
                                                      ...
                                                      @endif</a></li> 
                                                      @endforeach
                                            <li><a href="{{ route('front.contact',$sign) }}">{{ $langg->lang20 }}</li>
							...
							@endif
                                            ...
                                            <li><a href="{{route('front.checkout',$sign)}}">Shopping Cart</a></li>
                                            <li><a href="#">Terms & Conditions</a></li>
...
<!-- Plugins JS File -->
    ...
    <script src="{{asset('assets/demo_22/assets/js/jquery.min.js')}}"></script>
    <script src="{{asset('assets/demo_22/assets/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('assets/demo_22/assets/js/plugins.min.js')}}"></script>
    <script src="{{asset('assets/demo_22/assets/js/jquery.countdown/jquery.countdown.min.js')}}"></script>

    <!-- Main JS File -->
    <script src="{{asset('assets/demo_22/assets/js/main_init.min.js')}}"></script>
    <script src="{{asset('assets/demo_22/assets/js/main.min.js')}}"></script>
 ...
 <script>
    ...
    "use strict";
        ...
        $('.home-product-tabs .nav .nav-item:first .nav-link').addClass('active');
