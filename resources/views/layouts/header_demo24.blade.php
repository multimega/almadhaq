...
@endphp
    ...
    <!-- Plugins CSS File -->
    <link rel="stylesheet" href="{{asset('assets/demo_24/assets/css/bootstrap.min.css')}}">

    <!-- Main CSS File -->
    <link rel="stylesheet" type="text/css" href="{{asset('assets/demo_24/assets/vendor/fontawesome-free/css/all.min.css')}}">
    @if($langg->rtl == "1")
             <link rel="stylesheet" href="{{asset('assets/demo_24/assets/css/style.min.css')}}">
            <link rel="stylesheet" href="{{asset('assets/demo_24/assets/css/style-rtl.css')}}">
...
<body>
    <div class="page-wrapper">
        <header class="header">
            <div class="header-bottom sticky-header top-header top-header">
                <div class="container">
