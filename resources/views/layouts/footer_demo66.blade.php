...
@endphp
	...
	<footer class="footer tl-r" style="background-color:{{$gs->footer_color}}">
							...
							<div class="widget">
								...
								<ul class="links">
									...
									@if(!Auth::guard('web')->check()) 
                                        <a href="{{url('user/login')}}">{{ $langg->lang12 }}|{{ $langg->lang13 }}</a>
                         	        @else 
...
@if($gs->is_popup== 1)
@if(isset($visited))
    <div class="newsletter-popup mfp-hide" id="newsletter-popup-form" style="background:  #f1f1f1 no-repeat center/cover url({{asset('assets/images/'.$gs->popup_background)}})">
...
?>	
    ...
    <script src="{{asset('assets/demo_66/assets/js/jquery.min.js')}}"></script>
    <script src="{{asset('assets/demo_66/assets/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('assets/demo_66/assets/js/plugins.min.js')}}"></script>
    <script src="{{asset('assets/demo_66/assets/js/main.min.js')}}"></script>
