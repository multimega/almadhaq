...
@endif
    ...
    <!-- Plugins CSS File -->
    <link rel="stylesheet" href="{{asset('assets/demo_17/assets/css/bootstrap.min.css')}}">
    
  @if($langg->rtl == "1")
             <link rel="stylesheet" href="{{asset('assets/demo_17/assets/css/style.min.css')}}">
            <link rel="stylesheet" href="{{asset('assets/demo_17/assets/css/style.min-rtl.css')}}">
     ...
     @else
        ...
        <link rel="stylesheet" href="{{asset('assets/demo_17/assets/css/style.min.css')}}">
        <link rel="stylesheet" href="{{asset('assets/demo_17/assets/css/animate.min.css')}}">
