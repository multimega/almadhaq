				...
				<div class="footer-middle">
					<div class="row">
						<div class="col-lg-5 m-b-4">
							<img src="{{asset('assets/images/'.$gs->logo)}}" alt="Vowalaa Logo" class="m-b-4">
							...
							<div class="row ls-0">
								<div class="col-sm-6">
									<h6 class="text-uppercase mb-0">{{$langg->lang210}}</h6>
									<h3>{{$main->phone }}</h3>
								</div>
								<div class="col-sm-6">
									<h6 class="text-uppercase mb-0">Payment Methods</h6>
                                    <img src="{{ asset('assets/images/'.$main->paymentsicon)}}" alt="payment methods" class="footer-payments m-b-3">
								</div>
							</div>
						</div><!-- End .col-lg-5 -->
...
<script src="{{asset('assets/front/js/jquery.js')}}"></script>
    ...
    <script src="{{asset('assets/demo_3/assets/js/jquery.min.js')}}"></script>
    <script src="{{asset('assets/demo_3/assets/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('assets/demo_3/assets/js/plugins.min.js')}}"></script>
	<script src="{{asset('assets/demo_3/assets/js/optional/isotope.pkgd.min.js')}}"></script>

    <!-- Main JS File -->
    <script src="{{asset('assets/demo_3/assets/js/main.min.js')}}"></script>
