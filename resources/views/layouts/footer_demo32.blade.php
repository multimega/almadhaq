...
<footer class="footer" style="background-color:{{$gs->footer_color}}">
            <div class="footer-top">
                <div class="container">
                    <div class="footer-left nav-links">
                        ...
                        <a href="{{ route('front.contact',$sign) }}">{{ $langg->lang23 }}</a>
                    ...
                    <div class="footer-right header-dropdowns">
            ...
            <div class="footer-middle">
                <div class="container">
                    <div class="footer-left">
                        <a  href="{{url('/')}}" class="logo">
                            <img src="{{asset('assets/images/'.$gs->logo)}}" alt="vowalla Logo" width="110" height="46">
                        </a>
			    ...
			    @if(App\Models\Socialsetting::find(1)->f_status == 1)
                    ...
                    <img src="{{ asset('assets/images/'.$main->paymentsicon)}}" alt="payment_image" width="180" height="28">
                </div>
            </div>
...
?>	
    ...
    <!-- Plugins JS File -->
    <script src="{{asset('assets/demo_31/assets/js/jquery.min.js')}}"></script>
    <script src="{{asset('assets/demo_31/assets/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('assets/demo_31/assets/js/plugins.min.js')}}"></script>
    <script src="{{asset('assets/demo_31/assets/js/plugins/isotope-docs.min.js')}}"></script>

    <!-- Main JS File -->
    <script src="{{asset('assets/demo_31/assets/js/main.min.js')}}"></script><script src="{{asset('assets/front/js/popper.min.js')}}"></script>
	<!-- bootstrap -->
