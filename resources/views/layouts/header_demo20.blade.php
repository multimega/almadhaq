...
@endif
    ...
    <!-- Plugins CSS File -->
    <link rel="stylesheet" href="{{asset('assets/demo_20/assets/css/bootstrap.min.css')}}">
  ...
  @if($langg->rtl == "1")
         <link rel="stylesheet" href="{{asset('assets/demo_20/assets/css/style.min.css')}}">
         <link rel="stylesheet" href="{{asset('assets/demo_20/assets/css/style-rtl.css')}}">
                            ...
                            <ul class="menu sf-arrows">
                                <li class="active"><a href="{{route('front.index',$sign)}}">{{ $langg->lang17 }}</a></li>
                                    ...
                                    <a href="#" class="sf-with-ul">{{ $langg->lang14 }}</a>
                                        <div class="megamenu" style="min-width: 240px;">
