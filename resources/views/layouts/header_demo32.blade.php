...
@endphp
    ...
    <!-- Plugins CSS File -->
    <link rel="stylesheet" href="{{asset('assets/demo_32/assets/css/bootstrap.min.css')}}">

    <!-- Main CSS File -->
    <link rel="stylesheet" type="text/css" href="{{asset('assets/demo_32/assets/vendor/fontawesome-free/css/all.min.css')}}">
    @if($langg->rtl == "1")
        <link rel="stylesheet" href="{{asset('assets/demo_32/assets/css/style.min.css')}}">
        <link rel="stylesheet" href="{{asset('assets/demo_32/assets/css/style-rtl.css')}}">
            ...
            <div class="header-top top-header">
                <div class="container">
                    <div class="header-left">
                        @if($gs->is_shop == 1)
                        <h4>{{$langg->lang941}} </h4><hr class="vertical"><a href="{{ route('front.products',$sign) }}">{{$langg->lang25}}!</a>
                        @endif
                    </div>
