...
@endif
    ...
    <link rel="stylesheet" href="{{asset('assets/demo_8/assets/css/bootstrap.min.css')}}">
	<link rel="stylesheet" href="{{asset('assets/front/css/toastr.css')}}">
	<link rel="stylesheet" href="{{asset('assets/front/css/toastr.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/demo_8/assets/vendor/fontawesome-free/css/all.min.css')}}">
    
  @if($langg->rtl == "1")
    <link rel="stylesheet" href="{{asset('assets/demo_8/assets/css/style.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/demo_8/assets/css/style.min-rtl.css')}}">
...
<body>
    <div class="page-wrapper">
        <div class="top-notice text-white top-header">
                    ...
                    <div class="header-right">
                        ...
                        <div class="dropdown cart-dropdown">
                            <a href="#" class="dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static">
                                <span class="cart-count">{{ Session::has('cart') ? count(Session::get('cart')->items) : '0' }}</span>
                            </a>
                         ...
                         @endif
                          ...
                          @endif
                                                ...
                                                <figure class="product-image-container">
                                                    ...
                                                    <a  onClick="refreshCart()" class="cart-remove btn-remove" data-class="cremove{{ $product['item']['id'].$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values']) }}" data-href="{{ route('product.cart.remove',$product['item']['id'].$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values'])) }}" title="Remove Product"><i class="icon-retweet"></i></a>
                                                </figure>
                                            </div><!-- End .product -->
                                            @endforeach
                    ...
                    <nav class="main-nav">
                        <ul class="menu sf-arrows">
							...
							@foreach(DB::table('pages')->where('header','=',1)->get() as $data)
								...
								<li class="float-right"><a href="{{ route('front.offers',['slug' => $data->slug , 'lang' => $sign ]) }}">@if(!$slang)
                                                          @if($lang->id == 2)
                                                         {{ $data->name_ar }}
                                                          @else 
                                                         {{ $data->name }}
