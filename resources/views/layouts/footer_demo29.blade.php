...
@endphp
  ...
  <footer class="footer" style="background-color:{{$gs->footer_color}}">
            ...
            <div class="footer-top" style="background-color:#4DB7B3">
                <div class="container">
                    <div class="newsletter-widget">
                        <i class="icon-envolope"></i>

                        <div class="newsletter-info">
                            <h3>{{$langg->newsletter}}</h3>
                            <!--<p>{{$gs->subscribee_message}}</p>-->
                        </div>
                ...
                <div class="container">
                    <div class="row row-sm">
                        <div class="col-md-6 col-lg-3">
                           <a href="{{ route('front.index',$sign) }}" class="logo-link"> <img src="{{asset('assets/images/'.$gs->footer_logo)}}"></a>
                            <p>@if(!$slang)
                             @if($lang->id == 2)
                              {!! $gs->footer_ar !!}
                              @else 
                            ...
                            <div class="social-link">
                                <h3 class="link-title"> @if(!$slang)
                                              ...
                                              @endif
                                @endif</h3>
                                <a href="#"> <a href="tel:{{$gs->header_phone}}">{{$gs->header_phone}}</a></a>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3">
                            <div class="widget">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="widget">
                                <h3 class="widget-title">{{$langg->lang906}}</h3>
                                <div class="widget-content row row-sm">
                                    <ul class="col-xl-6">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="widget text-left">
                                <h3 class="widget-title">{{$langg->lang907}}</h3>
         ...
         <!--<p>Baristaeg eCommerce. © 2019. All Rights Reserved</p>-->
        ...
        <div class="modal-content">
          ...
          <div class="modal-body add-cart-box text-center">
            ...
            <div class="btn-actions">
                <button class="btn-primary"><a href="{{route('front.cart',$sign)}}">Go to cart page</a></button>
                <button class="btn-primary"><a href="{{route('front.index',$sign)}}">Continue</a></button>
            </div>
...
?>	
    ...
    <script src="{{asset('assets/demo_29/assets/js/jquery.min.js')}}"></script>
    <script src="{{asset('assets/demo_29/assets/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('assets/demo_29/assets/js/plugins.min.js')}}"></script>
    <script src="{{asset('assets/demo_29/assets/js/plugins/isotope-docs.min.js')}}"></script>
