...
$categorys=App\Models\Category::where('status',true)->get();
...
@endif
   ...
   <link rel="icon" type="image/x-icon" href="{{asset('assets/images/'.$gs->favicon)}}">
    ...
    <!-- Plugins CSS File -->
    <link rel="stylesheet" href="{{asset('assets/demo_29/assets/css/bootstrap.min.css')}}">
    ...
    @if($langg->rtl == "1")
      <link rel="stylesheet" href="{{asset('assets/demo_29/assets/css/style.min.css')}}">
      <link rel="stylesheet" href="{{asset('assets/demo_29/assets/css/style.min-rtl.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/demo_29/assets/vendor/fontawesome-free/css/all.min.css')}}">
...
<body>
    <div class="page-wrapper">
        <header class="header" style="background-color:{{$gs->header_color}}">
            ...
            <div class="header-middle sticky-header">
                <div class="container">
                   @if($langg->rtl != "1")
                     ...
                     <img src="{{asset('assets/images/'.$gs->logo)}}" alt="baristaegstore Logo" >
                    </a>
                   @endif
                     ...
                     <div class="header-right">
                        ...
                        <!--<a href="#" class="Vowalaa-icon"><i class="icon icon-wishlist-2"></i></a>-->
                        
                    <div style="margin-right:20px;" class="wishlist"  data-toggle="tooltip" data-placement="top" title="{{ $langg->lang9 }}">
								@if(Auth::guard('web')->check())
									<a href="{{ route('user-wishlists') }}" class="wish">
										<i class="far fa-heart"style="font-size: 26px;color: #393b3f;"></i>
            ...
            <!--                                    <div class="cart-remove" data-class="cremove{{ $product['item']['id'].$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values']) }}" data-href="{{ route('product.cart.remove',$product['item']['id'].$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values'])) }}" title="Remove Product">-->
                    ...
                    @endif
                     ...
                     <div class="header-left">
                        ...
                        <nav class="main-nav">
                            <ul class="menu" style="background-color:{{$gs->header_color}}">
                                <li>
           ...
           <div class="header-bottom">
                 ...
                 @if($key == 0)
                <div class="col-lg-4" style="background-color:#4DB7B3">
                ...
                @endif
                @if($key == 1)
                <div class="col-lg-4" style="background-color:#43ADA9">
                    <div class="service-widget">
