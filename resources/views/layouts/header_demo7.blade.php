...
@endif
    ...
    <!-- Plugins CSS File -->
    <link rel="stylesheet" href="{{asset('assets/demo_7/assets/css/bootstrap.min.css')}}">
    	<link rel="stylesheet" href="{{asset('assets/front/css/toastr.css')}}">
	<link rel="stylesheet" href="{{asset('assets/front/css/toastr.css')}}">

  @if($langg->rtl == "1")
             <link rel="stylesheet" href="{{asset('assets/demo_7/assets/css/style.css')}}">
            <link rel="stylesheet" href="{{asset('assets/demo_7/assets/css/style-rtl.css')}}">
    ...
    @endif
    <link rel="stylesheet" type="text/css" href="{{asset('assets/demo_7/assets/vendor/fontawesome-free/css/all.min.css')}}">
                                    ...
                                    <li><a href="{{ route('user-wishlists') }}">{{ $langg->lang9 }}</a></li>
                                     ...
                                     @if(!Auth::check())
                                      <li> <a href="{{url('user/login')}}">{{ $langg->lang12 }}</a>
                                       <li><a href="{{route('user-register')}}">{{ $langg->lang13 }}</a></li>
                                      </li>
                                        @else
        							    	<li>
                        ...
                        <div class="header-search">
                            ...
                            <form id="searchForm" class="search-form" action="{{ route('front.category', [ 'category' => Request::route('category'),  'subcategory' =>Request::route('subcategory'),  'childcategory' =>Request::route('childcategory'), 'lang' =>$sign]) }}" method="GET">
                                ...
                                <div class="header-search-wrapper">
                                    <input type="search" class="form-control" name="search" id="prod_name" placeholder="{{ $langg->lang2 }}" value="{{ request()->input('search') }}" autocomplete="on" required>
                         ...
                         @endif
                          ...
                          @endif
                                                ...
                                                <figure class="product-image-container">
                                                    ...
                                                    <a  onClick="refreshCart()" class="cart-remove btn-remove" data-class="cremove{{ $product['item']['id'].$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values']) }}" data-href="{{ route('product.cart.remove',$product['item']['id'].$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values'])) }}" title="Remove Product"><i class="fas fa-times"></i></a>
                                                </figure>
                                            </div><!-- End .product -->
                                            @endforeach
