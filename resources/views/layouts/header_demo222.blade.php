...
@endphp
    ...
    @if(isset($page->meta_tag) && isset($page->meta_description))
	    ...
	    <meta name="author" content="Maison Arabelle Trading LLC">
    	<title>	@if(!$slang)
              @if($lang->id == 2)
    ...
    <!-- Plugins CSS File -->
    <link rel="stylesheet" href="{{asset('assets/demo_222/assets/css/bootstrap.min.css')}}">

    <!-- Main CSS File -->
    <link rel="stylesheet" type="text/css" href="{{asset('assets/demo_222/assets/vendor/fontawesome-free/css/all.min.css')}}">
       @if($langg->rtl == 1)
             <link rel="stylesheet" href="{{asset('assets/demo_222/assets/css/style.min.css')}}">
            <link rel="stylesheet" href="{{asset('assets/demo_222/assets/css/style-rtl.css')}}">
...
<body>
	<div class="page-wrapper">
		<header class="header">
			<div class="header-top text-white top-header">
				<div class="container">

					<div class="header-right">
						<nav class="top-menu">
							<ul>
								<li class="active"><a href="{{ route('front.blog',$sign) }}">{{ $langg->lang18 }}</a></li>
								<li><a href="contact.html">{{ $langg->lang20 }}</a></li>
							</ul>
						</nav><!-- End .top-menu -->

						<div class="header-dropdowns text-upper">
							<div class="header-dropdown ml-xl-5 pl-2">
							...
							<div class="header-dropdown ml-xl-5 ml-0 pl-2">
								<a href="#">EN</a>
								<div class="header-menu">
									<ul>
					...
					<div class="container">
						<div class="header-left">
							<a href="{{route('front.index',$sign)}}" class="logo">
                                <img src="{{asset('assets/images/'.$gs->logo)}}" alt="Maison Arabelle Trading LLC" style="width: 225px;">
                            </a>
						</div><!-- End .header-left -->

						<div class="header-right">
							<a href="#" class="popup-menu-toggler"><i class="toggler-icon"></i>Menu</a>
...
<nav>
                            ...
                            <a href="{{url('user/login')}}" class="header-icon">
                                <i class="icon-user-2"></i>
                            </a>
                            @else
                                <a href="{{ route('user-wishlists') }}" class="header-icon"><i class="icon-wishlist-2"></i> {{ count(Auth::user()->wishlists) }}</a>
                             @endif
