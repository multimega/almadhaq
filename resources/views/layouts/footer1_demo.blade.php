                                ...
                                <ul class="contact-info">
                                    ...
                                    <div class="social-icons">
                                      ...
                                      @endif
                                       ...
                                       @if(App\Models\Socialsetting::find(1)->ystatus == 1)
                                        <a href="{{ App\Models\Socialsetting::find(1)->youtube }}" class="social-icon" target="_blank">
...
?>	
   ...
   <a id="scroll-top" href="#top" title="Top" role="button"><i class="icon-angle-up"></i></a>
    ...
    <script src="{{asset('assets/demo_4/assets/js/jquery.min.js')}}"></script>
    <script src="{{asset('assets/demo_4/assets/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('assets/demo_4/assets/js/plugins.min.js')}}"></script>
    <script src="{{asset('assets/demo_4/assets/js/main.min.js')}}"></script>
