...
<footer class="footer">
    ...
    <div class="newsletter-popup mfp-hide" id="newsletter-popup-form" style="background-image: url({{asset('assets/images/'.$gs->popup_background)}})">
        <div class="newsletter-popup-content">
            <img src="{{asset('assets/images/'.$gs->logo)}}" alt="Logo" class="logo-newsletter" style="width:50px;">
...
?>	
    ...
    <!-- Plugins JS File -->
    <script src="{{asset('assets/demo_26/assets/js/jquery.min.js')}}"></script>
    <script src="{{asset('assets/demo_26/assets/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('assets/demo_26/assets/js/plugins.min.js')}}"></script>

    <!-- Main JS File -->
    <script src="{{asset('assets/demo_26/assets/js/main.min.js')}}"></script>
