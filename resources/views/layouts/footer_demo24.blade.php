            ...
            <div class="container">
                <div class="footer-top">
                    <div class="row row-sm">
                        <div class="col-md-4 col-lg-3">
                            <div class="widget">
                                <h3 class="widget-title">{{ $langg->lang23 }}</h3>
			    ...
			    @if(App\Models\Socialsetting::find(1)->f_status == 1)
                    ...
                    <div class="newsletter-widget">
                        <div class="widget">
                            <h3 class="widget-title">{{$gs->popup_title}}</h3>
                            <p>{{$gs->popup_text}}</p>
                        </div>
...
?>
    ...
    <script src="{{asset('assets/demo_24/assets/js/jquery.min.js')}}"></script>
    <script src="{{asset('assets/demo_24/assets/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('assets/demo_24/assets/js/plugins.min.js')}}"></script>
    <script src="{{asset('assets/demo_24/assets/js/plugins/isotope-docs.min.js')}}"></script>

    <!-- Main JS File -->
    <script src="{{asset('assets/demo_24/assets/js/main.min.js')}}"></script>
...
<script>
	 ...
	 $('#prod_name').on('keyup',function(){
      ...
      $(function () {
        "use strict";
        $('.product-panel .row > div').hide();    
        $('.product-panel .row > div').slice(0,3).show();    
        $('.btn-view-more').click(function(){
            $('.product-panel .row > div').show(300);
            $(this).hide();
        })
