...
@endif
    ...
    <!-- Plugins CSS File -->
    <link rel="stylesheet" href="{{asset('assets/demo_22/assets/css/bootstrap.min.css')}}">

    <!-- Main CSS File -->
    <link rel="stylesheet" type="text/css" href="{{asset('assets/demo_22/assets/vendor/fontawesome-free/css/all.min.css')}}">
  ...
  @if($langg->rtl == "1")
             <link rel="stylesheet" href="{{asset('assets/demo_22/assets/css/style.min.css')}}">
            <link rel="stylesheet" href="{{asset('assets/demo_22/assets/css/style-rtl.css')}}">
            ...
            <div class="header-middle top-header">
                <div class="container">
                    ...
                    <div class="header-right">
                        ...
                        <a href="{{ route('user-wishlists') }}" class="Vowalaa-icon wishlist-icon porto-icon">
