        ...
        <div class="mobile-menu-wrapper">
            ...
            <nav class="mobile-nav">
                <ul class="mobile-menu">
                        <li><a href="{{url('front.index',$sign)}}">{{$langg->lang17}}</a></li>
                          <li>
...
?>
   ...
   <a id="scroll-top" href="#top" title="Top" role="button"><i class="icon-angle-up"></i></a>
    ...
    <script src="{{asset('assets/demo_5/assets/js/jquery.min.js')}}"></script>
    <script src="{{asset('assets/demo_5/assets/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('assets/demo_5/assets/js/plugins.min.js')}}"></script>
    <script src="{{asset('assets/demo_5/assets/js/main.min.js')}}"></script>

     <script src="{{asset('assets/front/js/popper.min.js')}}"></script>
	<!-- bootstrap -->
	<script src="{{asset('assets/front/js/bootstrap.min.js')}}"></script>
	<!-- plugin js-->
	<script src="{{asset('assets/front/js/plugin.')}}"></script>
