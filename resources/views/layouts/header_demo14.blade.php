...
@endif
    ...
    <!-- Plugins CSS File -->
    <link rel="stylesheet" href="{{asset('assets/demo_14/assets/css/bootstrap.min.css')}}">
  ...
  @if($langg->rtl == "1")
             <link rel="stylesheet" href="{{asset('assets/demo_14/assets/css/style.min.css')}}">
            <link rel="stylesheet" href="{{asset('assets/demo_14/assets/css/style.min-rtl.css')}}">
                                    ...
                                    <ul class="compare-products">
                                        ...
                                        <li class="product">
                                         ...
                                         <div class="compare-actions">
                                           <a href="{{url($sign.'/item/compare/view')}}" class="btn btn-primary">{{$langg->lang10}} </a>
                                       </div>
                                    @else
