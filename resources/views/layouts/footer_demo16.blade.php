...
?>	
    ...
    <script src="{{asset('assets/demo_16/assets/js/jquery.min.js')}}"></script>
    <script src="{{asset('assets/demo_16/assets/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('assets/demo_16/assets/js/plugins.min.js')}}"></script>

    <!-- Main JS File -->
    <script src="{{asset('assets/demo_16/assets/js/main.min.js')}}"></script>
