...
.sticky-header.fixed{
    background-color: #045c0c !important;
}
...
@endif
    ...
    <link rel="stylesheet" href="{{asset('assets/demo_13/assets/css/bootstrap.min.css')}}">
	...
	<link rel="stylesheet" href="{{asset('assets/front/css/toastr.css')}}">
      ...
      @if($langg->rtl == "1")
            <link rel="stylesheet" href="{{asset('assets/demo_13/assets/css/style.min-rtl.css')}}">
            <link rel="stylesheet" href="{{asset('assets/demo_13/assets/css/bootstrap.min-rtl.css')}}">
             <link rel="stylesheet" href="{{ asset('assets/front/css/rtl/styles.php?color='.str_replace('#','',$gs->colors).'&'.'header_color='.str_replace('#','',$gs->header_color).'&'.'footer_color='.str_replace('#','',$gs->footer_color).'&'.'copyright_color='.str_replace('#','',$gs->copyright_color).'&'.'menu_color='.str_replace('#','',$gs->menu_color).'&'.'menu_hover_color='.str_replace('#','',$gs->menu_hover_color)) }}">

       @else
        
        <link rel="stylesheet" href="{{asset('assets/demo_13/assets/css/style.min.css')}}">
         <link rel="stylesheet" href="{{ asset('assets/front/css/styles.php?color='.str_replace('#','',$gs->colors).'&'.'header_color='.str_replace('#','',$gs->header_color).'&'.'footer_color='.str_replace('#','',$gs->footer_color).'&'.'copyright_color='.str_replace('#','',$gs->copyright_color).'&'.'menu_color='.str_replace('#','',$gs->menu_color).'&'.'menu_hover_color='.str_replace('#','',$gs->menu_hover_color)) }}">

    @endif
    <link rel="stylesheet" type="text/css" href="{{asset('assets/demo_13/assets/vendor/fontawesome-free/css/all.min.css')}}">
    </head>
</head>
<body>
            ...
            <div class="header-middle sticky-header top-header">
                <div class="container-fluid">
                    <div class="header-left">
                        <nav class="main-nav">
                            <ul class="menu sf-arrows">
                               <li class=""><a href="{{route('front.index',$sign)}}">{{ $langg->lang17 }}</a></li>
                                   <li>
                  ...
                  <div class="header-search">
                        ...
                        <div class="header-dropdown links-menu dropdown-expanded d-md-none">
                            <a href="#">{{$langg->links}}</a>
                            <div class="header-menu">
                                <ul>
                                   <ul>
                        ...
                        @else
                        <a href="{{ route('user-profile') }}" class="head-icon"><i class="far fa-user"></i></a>
							  	<a href="{{ route('user-logout') }}" class="head-icon"><i class="fas fa-sign-out-alt"></i></a>
