                                ...
                                <div class="col-md-5">
                                     <div class="widget">
                                         <ul class="contact-info">
                                            ...
                                            <li>
                                                <span class="contact-info-label">{{$langg->lang209}}:</span><a href="tel:{{$main->email }}">{{$main->email }}</a>
                                            </li>
                                            <li>
                                                <span class="contact-info-label">{{$langg->lang210}}:</span> <a href="{{$main->phone}}">{{$main->phone}}</a>
                                            </li>
                                            <li>
                                            <li>
...
?>
    ...
    <script src="{{asset('assets/demo_18/assets/js/jquery.min.js')}}"></script>
    <script src="{{asset('assets/demo_18/assets/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('assets/demo_18/assets/js/plugins.min.js')}}"></script>
    <script src="{{asset('assets/demo_18/assets/js/main.min.js')}}"></script>
