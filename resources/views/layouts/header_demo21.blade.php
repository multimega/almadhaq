...
@endif
    ...
    <!-- Plugins CSS File -->
    <link rel="stylesheet" href="{{asset('assets/demo_21/assets/css/bootstrap.min.css')}}">
  ...
  @if($langg->rtl == "1")
             <link rel="stylesheet" href="{{asset('assets/demo_21/assets/css/style.min.css')}}">
            <link rel="stylesheet" href="{{asset('assets/demo_21/assets/css/style-rtl.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/demo_21/assets/vendor/fontawesome-free/css/all.min.css')}}">
    <style>
        .megamenu{
            min-width:240px;
            padding:0;
                        ...
                        <nav class="main-nav">
                            <ul class="menu">
                                ...
                                @if(!Auth::guard('web')->check())
									<li class="login">
										<a href="{{ route('user.login') }}">{{ $langg->lang12 }} | {{ $langg->lang13 }}</a>
									</li>
                        			...
                        			@elseif($gs->reg_vendor == 1)
                        				...
                        				@if(Auth::check())
	                        				@if(Auth::guard('web')->user()->is_vendor == 2)
	                        				    <li>
	                        					<a href="{{ route('user-package') }}">{{ $langg->lang11 }}</a>
	                        					</li>
	                        				@endif
									@endif
							       @else 
                             ...
                             @endif
                              ...
                              @endif
                                    ...
                                    <div class="dropdown-cart-action">
                                        <a href="{{route('front.checkout',$sign)}}" class="btn w-100">{{ $langg->lang7 }}</a>
                                    </div><!-- End .dropdown-cart-total -->
                                    @else 
									  <h3>{{ $langg->lang8 }}<h3/>
									@endif
