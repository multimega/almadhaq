...
@endif
    ...
    <script type="text/javascript">
        ...
        (function(d) {
            ...
            wf.src ='/assets/demo_18/assets/js/webfont.js';
            wf.async = true;
    ...
    <!-- Plugins CSS File -->
    <link rel="stylesheet" href="{{asset('assets/demo_18/assets/css/bootstrap.min.css')}}">
	<link rel="stylesheet" href="{{asset('assets/front/css/toastr.css')}}">
	<link rel="stylesheet" href="{{asset('assets/front/css/toastr.css')}}">
    <!-- Main CSS File -->
    @if($langg->rtl == "1")
      
   <link rel="stylesheet" href="{{asset('assets/demo_18/assets/css/style.min.css')}}">
		<link rel="stylesheet" href="{{asset('assets/demo_18/assets/css/style.min-rtl.css')}}">
...
@endif
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/demo_18/assets/vendor/fontawesome-free/css/all.min.css')}}">
    ...
    <div class="page-wrapper">
        <div class="top-notice bg-dark text-white">
			<div class="container text-center pl-6 pr-6">
				<h5 class="d-inline-block mb-0 m-r-1">Get Up to <b>40% OFF</b> New-Season Styles</h5>
				<a href="category.html" class="category">MEN</a>
				<a href="category.html" class="category m-l-1 m-r-2">WOMEN</a>
                ...
                <div class="container">
                    <div class="header-left header-dropdowns">
                        ...
                        <div class="dropdown compare-dropdown">
                            <a href="{{ route('product.compare',$sign) }}" class="dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static">
                                <i class="icon-retweet"></i> {{$langg->lang57}}   {{ Session::has('compare') ? count(Session::get('compare')->items) : '0' }}
                            </a>
                                    ...
                                    <ul class="compare-products">
                                        ...
                                        <li class="product">
                                            ...
                                            <div class="compare-actions">
                                                <a href="{{url('item/compare/view')}}" class="btn btn-primary">{{$langg->lang57}} </a>
                                            </div>
                                          	@else
                    ...
                    <div class="header-right">
                        <div class="header-contact">
                         ...
                         @if(!Auth::check()) 
                                    <a href="{{url('user/login')}}">{{ $langg->lang12 }}</a>
                                        @else
        							  	<li>
                ...
                <div class="container">
                    <div class="header-left"  >
                        <a href="{{route('front.index',$sign)}}" class="logo">
                             <img src="{{asset('assets/images/'.$gs->logo)}}" style="width:105px; height:57px;" alt="Porto Logo">
                        </a>
                    </div>
                         ...
                         @endif
                          ...
                          @endif
                                   ...
                                   <div class="dropdown-cart-action">
                                    ...
                                    <a href="{{route('front.checkout',$sign)}}" class="btn btn-block">{{ $langg->lang136 }}</a>
