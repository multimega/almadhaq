            ...
            <div class="footer-middle">
                <div class="container-fluid">
                    <div class="row">
                            ...
                            <div class="widget widget-social">
                                <div class="social-icons" style="color:#fff;">
                                    ...
                                    @if(App\Models\Socialsetting::find(1)->f_status == 1)
                                     <a href="{{ App\Models\Socialsetting::find(1)->facebook }}" class="social-icon facebook-backcolor" target="_blank"><i class="fab fa-facebook-f"></i></a>
                                    @endif
                                     @if(App\Models\Socialsetting::find(1)->t_status == 1)
                                     <a href="{{ App\Models\Socialsetting::find(1)->twitter }}" class="social-icon twitter-backcolor" target="_blank"><i class="fab fa-twitter"></i></a>
                                     @endif
                                      ...
                                      @endif
                                       ...
                                       <a href="{{ App\Models\Socialsetting::find(1)->instagram }}" class="social-icon insta-backcolor" target="_blank"><i class="fab fa-instagram"></i></a>
                                      @endif
                        ...
                        <div class="col-lg-2">
                            <div class="widget widget-social">
                            <a href="{{asset('assets/demo_19/assets/images/logos/Certificate.pdf')}}" class="" target="_blank">
                                <img src="{{asset('assets/demo_19/assets/images/logos/logo-white.png')}}" alt="payment methods">
                                </a>
                            </div><!-- End .widget -->
                        </div><!-- End .col-lg-3 -->
                    </div><!-- End .row -->
  ...
  @if(isset($visited))
    <div class="newsletter-popup mfp-hide" id="newsletter-popup-form" style="background-image: url({{asset('assets/images/'.$gs->popup_background)}})">
        <div class="newsletter-popup-content">
            <img src="{{asset('assets/images/'.$gs->logo)}}" alt="Logo" class="logo-newsletter" width="70">
...
?>	
   ...
   <a id="scroll-top" href="#top" title="Top" role="button"><i class="icon-angle-up"></i></a>
    ...
    <script src="{{asset('assets/demo_19/assets/js/jquery.min.js')}}"></script>
    <script src="{{asset('assets/demo_19/assets/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('assets/demo_19/assets/js/plugins.min.js')}}"></script>
    <script src="{{asset('assets/demo_19/assets/js/main.min.js')}}"></script>
