...
@endif
    ...
    <!-- Plugins CSS File -->
    <link rel="stylesheet" href="{{asset('assets/demo_9/assets/css/bootstrap.min.css')}}">
  ...
  @if($langg->rtl == "1")
             <link rel="stylesheet" href="{{asset('assets/demo_9/assets/css/style.css')}}">
            <link rel="stylesheet" href="{{asset('assets/demo_9/assets/css/style.min-rtl.css')}}">
