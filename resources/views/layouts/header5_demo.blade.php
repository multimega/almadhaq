...
@endif
	...
	<link rel="stylesheet" href="{{asset('assets/front/css/toastr.css')}}">
      ...
      <link rel="stylesheet" href="{{asset('assets/demo_5/assets/css/bootstrap.min.css')}}">
     
      
       @if($langg->rtl == "1")
      <link rel="stylesheet" href="{{asset('assets/demo_5/assets/css/style.min-rtl.css')}}">
      <link rel="stylesheet" href="{{ asset('assets/front/css/rtl/styles.php?color='.str_replace('#','',$gs->colors).'&'.'header_color='.str_replace('#','',$gs->header_color).'&'.'footer_color='.str_replace('#','',$gs->footer_color).'&'.'copyright_color='.str_replace('#','',$gs->copyright_color).'&'.'menu_color='.str_replace('#','',$gs->menu_color).'&'.'menu_hover_color='.str_replace('#','',$gs->menu_hover_color)) }}">

    @else
        
     <link rel="stylesheet" href="{{asset('assets/demo_5/assets/css/style.min.css')}}">
      <link rel="stylesheet" href="{{ asset('assets/front/css/styles.php?color='.str_replace('#','',$gs->colors).'&'.'header_color='.str_replace('#','',$gs->header_color).'&'.'footer_color='.str_replace('#','',$gs->footer_color).'&'.'copyright_color='.str_replace('#','',$gs->copyright_color).'&'.'menu_color='.str_replace('#','',$gs->menu_color).'&'.'menu_hover_color='.str_replace('#','',$gs->menu_hover_color)) }}">

       
    @endif
      <link rel="stylesheet" type="text/css" href="{{asset('assets/demo_5/assets/vendor/fontawesome-free/css/all.min.css')}}">
    ...
    <div class="page-wrapper">
        <header class="header">
            ...
            <div class="header-top top-header" style="color:white; background-color:{{$gs->colors}}">
                <div class="container">
                                    ...
                                    <ul class="compare-products">
                                        ...
                                        <li class="product">
                                            ...
                                            <div class="compare-actions">
                                                <a href="{{url('item/compare/view')}}" class="btn btn-primary">Compare</a>
                                            </div>
                                          	@else
                    ...
                    <div class="header-right">
                        ...
                        <div class="header-dropdown dropdown-expanded">
                            ...
                            <div class="header-menu" style="background-color:{{$gs->colors}}">
                                <ul>
                                    ...
                                    <li><a href="{{route('front.contact',$sign)}}">{{ $langg->lang20 }}</a></li>
                                      @if(!Auth::check()) 
                                      <li> <a href="{{url('user/login')}}">{{ $langg->lang12 }}
                                        @else
          ...
          <div class="header-middle">
                         ...
                         @endif
                          ...
                          @endif
                                   ...
                                   <div class="dropdown-cart-action">
                                    <a href="{{route('fornt.cart',$sign)}}" class="btn">{{ $langg->lang6 }}</a>
                                             &nbsp; &nbsp; 
           ...
           @else
                        ...
                        <div class="dropdown cart-dropdown">
                         ...
                         @endif
                          ...
                          @endif
                                   ...
                                   <div class="dropdown-cart-action">
                                    <a href="{{route('front.cart',$sign)}}" class="btn">{{ $langg->lang6 }}</a>
                                             &nbsp; &nbsp; 
            ...
            <div class="header-bottom sticky-header">
                <div class="container">
                    <nav class="main-nav" style="font-size:1.5rem; color:white; background-color:{{$gs->colors}}">
                         @if($langg->rtl == 1)
                        <ul class="menu sf-arrows" style="float:right;">
                          @else
                          <ul class="menu sf-arrows" style="float:left">
                         @endif
                                <li>
                                   	@if($gs->is_home == 1)
