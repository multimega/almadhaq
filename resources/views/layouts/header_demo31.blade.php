...
@endphp
    ...
    <!-- Plugins CSS File -->
    <link  rel="stylesheet" href="{{asset('assets/demo_31/assets/css/bootstrap.min.css')}}">

    <!-- Main CSS File -->
    <link rel="stylesheet" type="text/css" href="{{asset('assets/demo_31/assets/vendor/fontawesome-free/css/all.min.css')}}">
    @if($langg->rtl == "1")
        <link rel="stylesheet" href="{{asset('assets/demo_31/assets/css/style.min.css')}}">
        <link rel="stylesheet" href="{{asset('assets/demo_31/assets/css/style-rtl.css')}}">
                ...
                <div class="container">
                    <div class="header-left">
                        <div class="header-contact phone">
                            ...
                            <a href="tel:{{$main->phone }}" class="contact-phone">{{$main->phone }} </a>
                        </div>
                        <div class="header-contact">
                            <a href="{{ route('user-wishlists') }}">{{ $langg->lang9 }}</a>
                        </div>
                        <div class="header-contact">
                            <a href="{{ route('front.contact',$sign) }}">{{ $langg->lang20 }}</a>
                        </div>
                    </div>
                         ...
                         @endif
                          ...
                          @endif
                                                ...
                                                <figure class="product-image-container">
                                                    ...
                                                    <a class="cart-remove btn-remove" data-class="cremove{{ $product['item']['id'].$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values']) }}" data-href="{{ route('product.cart.remove',$product['item']['id'].$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values'])) }}" title="Remove Product" onClick="refreshCart('https://version3.vooecommerce.com/en')"><i class="icon-retweet"></i></a>
                                                </figure>
                                            </div><!-- End .product -->
                                            @endforeach
                                            </div>
