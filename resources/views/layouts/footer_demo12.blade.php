            ...
            <footer class="footer"style="">
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="widget widget-action">
                                <h4 class="widget-title">{{$langg->lang910}}</a></h4>
                            </div><!-- End .widget -->
                        </div><!-- End .col-lg-5 -->
                            ...
                            <div class="widget widget-newsletter">
                                <h4 class="widget-title">{{$langg->newsletter}}</h4>
                                 <form action="{{route('front.subscribe')}}" id="subscribeform" method="POST">
                                            ...
                                            <input style="color:white; background-color:{{$gs->colors}}" type="submit" class="btn" value="Subscribe">
                                        </form>
                            </div><!-- End .widget -->
                        </div><!-- End .col-lg-7 -->
                    </div><!-- End .row -->
                ...
                <div class="footer-middle">
                    <div class="row">
                        ...
                        <!--    <img src="{{asset('assets/images/'.$gs->logo)}}" class="footer-logo" alt="Footer logo">-->
                        <!--</div>-->
...
?>
   ...
   <a id="scroll-top" href="#top" title="Top" role="button"><i class="icon-angle-up"></i></a>
    ...
    <script src="{{asset('assets/demo_12/assets/js/jquery.min.js')}}"></script>
    <script src="{{asset('assets/demo_12/assets/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('assets/demo_12/assets/js/plugins.min.js')}}"></script>
    <script src="{{asset('assets/demo_12/assets/js/main.min.js')}}"></script>
