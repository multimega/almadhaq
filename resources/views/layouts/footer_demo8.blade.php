...
@endphp
	...
	<footer class="footer bg-dark tl-r" style="background-color:{{$gs->footer_color}}">
			<div class="footer-middle">
						...
						<div class="col-lg-3 col-sm-6 pb-5 pb-sm-0">
							<div class="widget">
								<h4 class="widget-title">{{ $langg->lang912 }}</h4>
									...
									<img src="{{asset('assets/images/'.$gs->footer_logo)}}" alt="Logo" class="m-b-3">
								<p class="m-b-4 pb-1">@if(!$slang)
                             @if($lang->id == 2)
                              {!! $gs->footer_ar !!}
                              @else 
                             {!! $gs->footer !!}
                             ...
                             {!! $gs->footer !!}
                              @endif
                              @endif</p>
								<a href="#" class="read-more text-white">{{ $langg->lang34 }}...</a>
							</div><!-- End .widget -->
						</div><!-- End .col-lg-3 -->

						<div class="col-lg-3 col-sm-6 pb-5 pb-sm-0">
							<div class="widget mb-2">
								<h4 class="widget-title mb-1 pb-1">  @if($langg->rtl != "1") CONTACT INFO @else  معلومات التواصل  @endif</h4>
								<ul class="contact-info m-b-4">
									<li>
										<span class="contact-info-label">{{$langg->lang155}}:</span> <span>@if(!$slang)
                                              @if($lang->id == 2)
                                              {{ $gs->address_ar }}
                                              @else 
                                              {{ $gs->address }}
			    ...
			    @if(App\Models\Socialsetting::find(1)->f_status == 1)
							...
							<div class="widget">
								...
								<ul class="links">
									...
									<li>  @if(!Auth::guard('web')->check()) 
                                        <a href="{{url('user/login')}}" class="header-user m-0">
						...
						<div class="col-lg-3 col-sm-6 pb-5 pb-sm-0">
							<div class="widget">
								<h4 class="widget-title">{{ $langg->lang63 }}</h4>
        ...
        <div class="modal-content">
          <div class="modal-body add-cart-box text-center">
            ...
            <div class="btn-actions">
                <a href="{{route('front.cart',$sign)}}"><button class="btn-primary">@if($langg->rtl !="1") Go to cart page @else اذهب الى عربة التسوق  @endif</button></a>
               <button class="btn-primary"> <a href="{{route('front.index',$sign)}}">{{$langg->lang753}}</a></button>
          </div>
        </div>
      </div>
    </div>
...
?>		
   ...
   <a id="scroll-top" href="#top" title="Top" role="button"><i class="icon-angle-up"></i></a>
    ...
    <script src="{{asset('assets/demo_8/assets/js/jquery.min.js')}}"></script>
    <script src="{{asset('assets/demo_8/assets/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('assets/demo_8/assets/js/plugins.min.js')}}"></script>
    <script src="{{asset('assets/demo_8/assets/js/main.min.js')}}"></script>
