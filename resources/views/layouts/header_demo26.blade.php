...
<link href="https://fonts.googleapis.com/css2?family=Cairo:wght@600&display=swap" rel="stylesheet"> 
    ...
    <!-- Plugins CSS File -->
    <link rel="stylesheet" href="{{asset('assets/demo_26/assets/css/bootstrap.min.css')}}">

    <!-- Main CSS File -->
    <link rel="stylesheet" href="{{asset('assets/demo_26/assets/css/style.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/demo_26/assets/vendor/fontawesome-free/css/all.min.css')}}">
    @if($langg->rtl == "1")
        <link rel="stylesheet" href="{{asset('assets/demo_26/assets/css/style.min.css')}}">
        <link rel="stylesheet" href="{{asset('assets/demo_26/assets/css/style-rtl.css')}}">
                ...
                <div class="container">
                    ...
                    <nav class="main-nav header-right">
                        <div class="header-search">
                             <a href="#" class="search-toggle" role="button"><i class="icon-magnifier"></i>{{ $langg->lang36 }}</a>
                            <form id="searchForm" class="search-form" action="{{ route('front.category', [ 'category' => Request::route('category'),  'subcategory' =>Request::route('subcategory'),  'childcategory' =>Request::route('childcategory'), 'lang' =>$sign]) }}" method="GET">
                                ...
                                <div class="header-search-wrapper">
	                               <input type="text" id="prod_name" class="form-control" name="search" placeholder="{{ $langg->lang2 }}" value="{{ request()->input('search') }}" autocomplete="on">
						      	    ...
						      	    <div id="myInputautocomplete-list" class="autocomplete-items" style="display: none;">
								  </div>  
								  <div id="myInputautocomplet" class="autocomplete-items"style="
                                            cursor: pointer;
                                            width: 95%;
                                            color: #fff;
                                            font-size: 15px;
