...
$tap= App\Models\PaymentGateway::where('status','=',1)->Where('title', 'like', '%' . 'tap' . '%')->first();
$tabby= App\Models\PaymentGateway::where('status','=',1)->Where('title', 'like', '%' . 'tabby' . '%')->first();
                                    ...
                                    <div class="content">
                                        <div class="personal-info">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
    @if (Auth::check())
        {{-- Show email field for logged in users --}}
    ...
    @endif
                                        ...
                                        <div class="billing-address">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6" style="    margin-bottom: 10px;">
                                                    <select class="form-control ff" name="customer_country" required="">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <select id="citySelect" class="form-control" name="city" required>
                                                        ...
                                                        {{-- @foreach($cities as $data)
                                                        @if($data->status == 1)
                                                        <option value="{{ $data->name }}" @if(Auth::guard('web')->
                                                            check() && Auth::guard('web')->user()->city == $data->name)
                                                            selected @endif>
                                                            {{ $data->name }}
                                                        </option>
                                                        @endif
                                                ...
                                                <div class="col-lg-6">
                                                    <input class="form-control" type="text" name="area"
                                                        placeholder="{{ __('Area') }}" required="" value="">
                                                </div>

                                                <div class="col-lg-6">
                                                    <input class="form-control" type="text" name="building_number"
                                                        placeholder="{{ __('Building Number') }}" required="" value="">
                                                </div>
...
<div class="col-lg-6">
                                                    ...
                                                    <div class="phone">
                                                        ...
                                                        <input class="form-control" type="text" name="phone"
                                                            ...
                                                            minlength="{{$country->phone_numbers}}"
                                                            maxlength="{{$country->phone_numbers}}" required="">
@else
                                                    ...
                                                    @php
                                                    $address =
                                                    App\Models\Address::where('user_id',Auth::guard('web')->user()->id)->where('phone','!=',
                                                    null)->get();
                                                    ...
                                                    @if(!empty(Auth::guard('web')->user()->phone) || count($address) >
                                                    0)

                                                    <div class="phone">
                                                        <select class="form-control" name="phone">
                                                            @if(!empty(Auth::guard('web')->user()->phone)) <option
                                                                value="{{Auth::guard('web')->user()->phone}}">
                                                                {{Auth::guard('web')->user()->phone}}</option> @endif
                                                ...
                                                <div class="product-content">
                                                    ...
                                                    <div class="unit-price">
                                                        ...
                                                        <p>{{ App\Models\Product::convertPrice($product['item']['price']
                                                            != 0 ? $product['item']['price'] : $product['size_price'] )
                                                            }}</p>
                                                    </div>
                                                    ...
                                                    $atrroption =
                                                    App\Models\AttributeOption::where('name',$value)->first();
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 mt-3">
                                                <div class="bottom-area">
                                                    <a href="javascript:;" id="step1-btn" class="mybtn1 mr-3">{{
                                                        $langg->lang757 }}</a>
                                                    <a href="javascript:;" id="step3-btn" class="mybtn1">{{
                                                        $langg->lang753 }}</a>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="nav flex-column" role="tablist"
                                                        ...
                                                        @php
                                                        $isArabic = (!$slang && isset($lang) && $lang->id == 2) ||
                                                        ($slang == 2);

                                                        $paymentGateways = App\Models\PaymentGateway::where('status',
                                                        1)->get();
                                                        @endphp
                                                        ...
                                                        @php
                                                        $title = $isArabic ? $paymentGateway->title_ar :
                                                        $paymentGateway->title;
                                                        $details = $isArabic ? $paymentGateway->details_ar :
                                                        $paymentGateway->details;
                                                        @endphp


                                                        <a class="nav-link payment" data-val="{{ $paymentGateway->id }}"
                                                            data-show="no"
                                                            ...
                                                            data-toggle="pill" href="#v-pills-tab4" role="tab"
...
<br>
                                                        ...
                                                        @if($bankkmasr)
                                                        <a class="nav-link payment" data-val="misrbank" data-show="no"
                                                            data-form="{{route('gateway.submit')}}"
                                                            data-href="{{ route('front.load.payment',['slug1'=>'misrbank','slug2' => 0]) }}"
                                                            id="v-pills-tab2-tab" data-toggle="pill"
                                                            href="#v-pills-tab2" role="tab" aria-controls="v-pills-tab7"
                                                            aria-selected="false">
                                                        ...
                                                        @if($accept)
                                                        <a class="nav-link payment" data-val="acceptss" data-show="no"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 mt-3">
                                                <div class="bottom-area">
                                                    ...
                                                    <a href="javascript:;" id="step2-btn" class="mybtn1 mr-3">{{
                                                        $langg->lang757 }}</a>
                                                    <button type="submit" id="final-btn" class="mybtn1">{{
                                                        $langg->lang753 }}</button>
                                                </div>
                    ...
                    <div class="order-box">
                        ...
                        <ul class="order-list">
                            ...
                            <li class="discount-bar">
                                <p>
                                    {{ $langg->lang145 }} <span class="dpercent">{{ Session::get('coupon_percentage') ==
                                        0 ? '' : '('.Session::get('coupon_percentage').')' }}</span>
                                </p>
                                <P>
                                    ...
                                    <span class="currency">{{ $curr->sign }}</span> <b id="discount">{{
                                        Session::get('coupon') }}</b>
                                    @else
                        ...
                        <div class="total-price">
                            ...
                            <p>
                                ...
                                @if(Session::has('coupon_total'))
                                @if($gs->currency_format == 0)
                                <span class="currency">{{ $curr->sign }}</span> <span id="total-cost">{{ $totalPrice
                                    }}</span>
                                @else
                                <span id="total-cost">{{ $totalPrice }}</span><span class="currency">{{ $curr->sign
                                    }}</span>
                                @endif
                        ...
                        <div class="final-price">
                            ...
                            <p>
                                @if(Session::has('coupon_total'))
                                @if($gs->currency_format == 0)
                                <span class="currency">{{ $curr->sign }}</span> <span id="final-cost">{{ $totalPrice
                                    }}</span>
                                @else
                                <span id="final-cost">{{ $totalPrice }}</span> <span class="currency">{{ $curr->sign
                                    }}</span>
                                @endif
                                ...
                                @else
                                <span id="final-cost">{{ App\Models\Product::convertPrice($totalPrice) }}</span> <span
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (countrySelect) {
            const targetOption = Array.from(countrySelect.options).find(option => option.value === "United Arab Emirates");
            ...
            if (!cityName) {
                ...
                .then(data => {
                    if (data.success && data.next_available) {
                        ...
                        const formattedText = `🚚 ${deliveryText}: ${slot.day}, ${slot.formatted_date} (${to12HourFormat(slot.schedule.start_time)} - ${to12HourFormat(slot.schedule.end_time)})`;
...
$('#shipping-cost').val(mship);
var ttotal = parseFloat($('#tgrandtotal').val()) + parseFloat(mship) + parseFloat(mpack) + parseFloat( $(".shipping_price").val())- parseFloat(wallet);
...
//$('#wallet-cost').val(0);
   ...
   var wl =  parseFloat(wallet)  - parseFloat($('#tgrandtotal').val()) + parseFloat(mship) + parseFloat( $(".shipping_price").val()) + parseFloat(mpack);
   $('#wallet-cost').val(wl);
...
// @if(Auth::check())
// 		var shipping_email = !$('input[name="shipping_email"]').val() ? $('input[name="personal_email"]').val() : $('input[name="shipping_email"]').val();
//         @else
// 		var shipping_email= !$('input[name="shipping_email"]').val() ? $('input[name="personal_email"]').val() : $('input[name="shipping_email"]').val();
...
$('#step3-btn').on('click', function () {
    ...
    @if (Auth::check())
    var shipping_email = !$('input[name="shipping_email"]').val() ? $('input[name="personal_email"]').val() : $('input[name="shipping_email"]').val();
    var shipping_phone = !$('input[name="shipping_phone"]').val() ? $('select[name="phone"]').val() : $('input[name="shipping_phone"]').val();
@else
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $.ajax({
                url: url,
                method: 'POST',
                data: {id: city_id, product: product, _token: token},
                success: function(data) {
                    /* $("#final-btn").removeAttr("disabled");*/
...
<script>
    function allowCashCheck(){
        ...
        $.ajax({
            url: url,
            method: 'POST',
            data: {id:selectedCity,_token:token},
            dataType: 'json',
            success: function(data) {
                console.log(data);
