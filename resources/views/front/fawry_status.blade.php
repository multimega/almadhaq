                        ...
                        <div class="content-box section-padding add-product-1">
                            <div class="top-area">
                                ...
                                <div class="checkout-steps-action">
                                    <button class="mybtn1" type="image" onclick="checkout()" alt="pay-using-fawry"
                                        id="fawry-payment-btn">pay with fawry</button>
                                            ...
                                            <div class="col-md-12" id="tempview">
                                                <div class="dashboard-content">
                                                    <div class="view-order-page" id="print">
                                                        ...
                                                        <p><strong>تكلفة الشحن
                                                            </strong>{{ $order->currency_sign }}{{ round($order->shipping_price * $order->currency_value, 2) }}
                                                        </p>
                                                        <p> <strong>التكلفة الأجمالية </strong>
                                                            {{ $order->currency_sign }}{{ round(($order->shipping_price + $order->pay_amount) * $order->currency_value, 2) }}
                                                        </p>
                                                        <br>
