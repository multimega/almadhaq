                    ...
                    <ul class="pages">
                        ...
                        <li>
                            @if (!$slang)
                                @if ($lang->id == 2)
                                    <a
                                        href="{{ route('front.category', ['category' => $productt->category->slug_ar, 'lang' => $sign]) }}">
                                        {{ $productt->category->name_ar }}
                                    @else
                                        <a
                                            href="{{ route('front.category', ['category' => $productt->category->slug, 'lang' => $sign]) }}">
                        ...
                        <li>
                            @if (!$slang)
                                @if ($lang->id == 2)
                                    ...
                                    @else
                                        <a
                                            href="{{ route('front.product', ['slug' => $productt->slug, 'lang' => $sign]) }}">
                                            {{ $productt->name }}
                                @endif
                            @else
                                @if ($slang == 2)
                        ...
                        <div class="col-lg-5 col-md-12">
                            ...
                            <div class="xzoom-container">
                                <a class="lightbox-color-img"
                                    ...
                                    @else
                                        @if ($slang == 2) alt="{{ $productt->alt_ar }}"
                                         @else
                                         alt="{{ $productt->alt }}" @endif
                                        @endif
                                    />
                        ...
                        <div class="col-lg-7">
                            <div class="right-area">
                                <div class="product-info">
                                    ...
                                    @php
                                        $colors = App\Models\Color::where('product_id', $productt->id)
                                            ->where('size_qty', '>', 0)
                                            ->first();

                                        $sizes = App\Models\Color::where('product_id', $productt->id)
                                            ->where('size_qty', '>', 0)
                                            ->distinct('size')
                                            ->get();
                                    ...
                                    @if (!empty($productt->size))
                                        <div class="product-size">
                                            ...
                                            <ul class="siz-list siz-lists">
                                                @php
                                                    $co = App\Models\Color::where('product_id', $productt->id)
                                                        ->where('size', $productt->size[0])
                                                        ->where('size_qty', '>', 0)
                                                        ->get();
                                                    $is_first = true;
                                                @endphp
                                                        ...
                                                        <li class=" click  {{ $is_first ? 'active' : '' }}">
                                                            <span class="box boxz" data-color="{{ $data1->colors }}"
                                                                ...
                                                                <input type="hidden" class="color_price"
                                                                    value="{{ $data1->size_price * $curr->value }}">
                                            ...
                                            <div class="tab-content-wrapper">
                                                <div id="tabs-1" class="tab-content-area">
                                                    <p>
                                                        ...
                                                        @if ($productt->youtube != null)
                                                            <div class="contvad">
                                                                <iframe class="responsive-iframe" width="560"
                                                                    height="315" src="{{ $productt->youtube }}"
                                                                    frameborder="0"
...
@else
    ...
    @if (Auth::guard('web')->user()->favorites()->where('vendor_id', '=', $productt->user->id)->get()->count() > 0)
                        ...
                        <div class="seller-info mt-3">
                            <div class="content">
                                @if (!$slang)
                                    @if ($lang->id == 2)
                                        <a
                                            href="{{ route('front.singlebrands', ['slug' => $productt->brand->slug_ar, 'lang' => $sign]) }}"><img
                                                src="{{ asset('assets/images/brands/' . $productt->brand->photo) }}" /></a>
                                    @else
                                        <a
                                            href="{{ route('front.singlebrands', ['slug' => $productt->brand->slug, 'lang' => $sign]) }}"><img
                                                src="{{ asset('assets/images/brands/' . $productt->brand->photo) }}" /></a>
                                    @endif
                                @else
                                    @if ($slang == 2)
