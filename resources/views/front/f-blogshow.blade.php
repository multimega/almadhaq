          ...
          <div class="blog-content">
            ...
            <div class="content">
                ...
                <h3 class="title">
                  ...
                  <div class="tag-social-link d-flex justify-content-between">
                    <div class="tag">
        ...
        <div class="col-lg-4">
          <div class="blog-aside">
            ...
            <div class="categori">
              ...
              <ul class="categori-list list-unstyled p-0">
                @foreach($bcats as $cat)
                <li>
                  <a href="{{ route('front.f-blogcategory',['slug' => $cat->slug ,'lang' => $sign ]) }}"  {!! $cat->id == $blog->category_id ? 'class="active"':'' !!}>
                    <span>  @if(!$slang)
                                                      @if($lang->id == 2)
                                                      {{ $cat->name_ar }}
                                                      @else 
                ...
                <li>
                  <div class="post">
                    ...
                    <div class="post-details">
                      <a href="{{ route('front.f-blogshow',['id' => $blog->id ,'lang' => $sign ]) }}">
                          <h4 class="post-title">
                                @if(!$slang)
                                                      @if($lang->id == 2)
            ...
            <div class="archives">
              ...
              <span class="separator"></span>
              <ul class="archives-list list-unstyled p-0">
                @foreach($archives as $key => $archive)
                <li>
                  <a href="{{ route('front.f-blogarchive',['slug' => $key ,'lang' => $sign ]) }}">
                    <span>{{ $key }}</span>
            ...
            <div class="tags">
              ...
              <span class="separator"></span>
              <ul class="tags-list list-unstyled p-0">
                @foreach($tags as $tag)
                  @if(!empty($tag))
                  <li>
                    <a href="{{ route('front.f-blogtags',['slug' => $tag ,'lang' => $sign ]) }}">{{ $tag }} </a>
                  </li>
                  @endif
                @endforeach
              </ul>
