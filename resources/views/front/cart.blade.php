...
(function(){
  ...
  var payload = { event: 'add_to_cart', _event: 'add_to_cart', user_email: _siteUser.user_email || '', user_phone: _siteUser.user_phone || '', currency: pending.currency || 'SAR', value: value, items: items, ecommerce: { currency: pending.currency || 'SAR', value: value, items: items } };
