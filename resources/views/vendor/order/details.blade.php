                                ...
                                @if($product['item']['user_id'] != 0)
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                ...
                                                @endphp
                                                @if(isset($user))
                                              <a target="_blank" href="{{ route('front.product', ['lang' => $lang,'slug'=>$product['item']['slug'] ]) }}">{{strlen($product['item']['name']) > 30 ? substr($product['item']['name'],0,30).'...' : $product['item']['name']}}</a>
                                                @else
