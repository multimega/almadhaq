...
@endphp
          ...
          @endif
											<div class="item-img">
												...
												<img class="img-fluid" src="{{ $prod->photo ? filter_var($prod->photo, FILTER_VALIDATE_URL) ? $prod->photo :asset('assets/images/products/'.$prod->photo):asset('assets/images/noimage.png') }}" alt="" style="width:100%;height:auto;">
											</div>
											<div class="info">
											    {{--
												<div class="stars">
