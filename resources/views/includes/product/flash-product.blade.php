          ...
          @endif
													<div class="item-img">
														...
														<img class="img-fluid" src="{{ $prod->photo ? filter_var($prod->photo, FILTER_VALIDATE_URL) ? $prod->photo :asset('assets/images/thumbnails/'.$prod->thumbnail):asset('assets/images/noimage.png') }}" alt="" style="width:100%;height:auto;">
													</div>
													<div class="info">
												    {{--
														<div class="stars">
														...
														--}}
														<h4 class="price">{{ $prod->showPrice() }} <del><small>@if(!$slang)
              @if($lang->id == 2)
          ...
          @else  
             ...
             {{ $prod->showPreviousPrice() }}
              @endif
          @endif</small></del></h4>
																<h5 class="name"> @if(!$slang)               @if($lang->id == 2)              {!! $prod->showName_ar() !!}               @else                {{ $prod->showName() }}               @endif            @else                 @if($slang == 2)                {!! $prod->showName_ar() !!}               @else               {{ $prod->showName() }}               @endif           @endif</h5>
        ...
        {{ $prod->showPrice_ar() }}
          ...
          @endif</small></del></h4>
								...
								<div class="item-cart-area">
															@if($prod->product_type == "affiliate")
																<span class="add-to-cart-btn affilate-btn" data-href="{{ route('affiliate.product',['slug' => $prod->slug ,'lang' => $sign]) }}"><i class="icofont-cart"></i> {{ $langg->lang251 }}
																</span>
															@else
																...
																<span class="add-to-cart-quick add-to-cart-btn" data-href="{{ route('product.cart.quickadd',['id' => $prod->id , 'lang' => $sign]) }}">
																	<i class="icofont-cart"></i> {{ $langg->lang251 }}
																</span>
