        <div class="col-lg-4">
          <div class="user-profile-info-area">
            ...
            $features= App\Models\Feature::all();
              ...
              <li class="{{ $link == route('user-promo-codes') ? 'active':'' }}">
                  <a href="{{route('user-promo-codes')}}">{{ $langg->lang812 }}</a>
              </li> 
              @endif
              @if($features[2]->status == 1 && $features[2]->active == 1 )
              <li class="{{ $link == route('user-wallet') ? 'active':'' }}">
                  <a href="{{route('user-wallet')}}">{{ $langg->lang811 }}</a>
              </li> 
              @endif
              @if($features[1]->status == 1 && $features[1]->active == 1 )
              <li class="{{ $link == route('user-points') ? 'active':'' }}">
                  <a href="{{route('user-points')}}">{{ $langg->lang809 }}</a>
              </li>
                @endif 
              <!--  @if($features[3]->status == 1 && $features[3]->active == 1 )-->
              <!--<li class="{{ $link == route('user-refelar') ? 'active':'' }}">-->
              <!--    <a href="{{route('user-refelar')}}">{{ $langg->lang810 }}</a>-->
              <!--</li>-->
              <!--  @endif-->
             ...
             @endif
              ...
              <li class="{{ $link == route('user-address') ? 'active':'' }}">
