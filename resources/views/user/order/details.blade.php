                    ...
                    <div class="user-profile-details">
                        <div class="order-details">
                            ...
                            <div class="view-order-page">
                                <h3 class="order-code">{{ $langg->lang285 }} {{ $order->order_number }} [ @if ($order->status == 'pending')
                                        {{ $langg->lang540 }}
                                    @endif
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <p>{{ $langg->lang798 }}:
                                                    {!! $order->payment_status == 'Pending'
                                                        ...
                                                        : "<span class='badge badge-success'>" . $langg->lang800 . '</span>' !!}
                                                </p>
                                                ...
                                                @if ($order->method != 'Cash On Delivery')
                                                    ...
                                                    <form id="tform">
                                                        <input style="display: none; width: 100%;" type="text"
                                                            id="tin" placeholder="{{ $langg->lang299 }}"
                                                            required="" class="mb-3">
                                ...
                                <div class="table-responsive">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if ($product['item']['user_id'] != 0)
                                                            ...
                                                            @if (isset($user))
                                                                ...
                                                                @if (!$slang)
                                                                    @if ($lang->id == 2)
                                                                        {{ strlen($product['item']['name_ar']) > 30 ? substr($product['item']['name_ar'], 0, 50) . '...' : $product['item']['name_ar'] }}
                                                                    @else
                                                                        {{ strlen($product['item']['name']) > 30 ? substr($product['item']['name'], 0, 50) . '...' : $product['item']['name'] }}
                                                                    @endif
                                                                @else
                                                                    @if ($slang == 2)
                                                                        {{ strlen($product['item']['name_ar']) > 30 ? substr($product['item']['name_ar'], 0, 50) . '...' : $product['item']['name_ar'] }}
                                                    ...
                                                    <td>
                                                        ...
                                                        @if (!empty($product['size']))
                                                            <b>{{ $langg->lang312 }}</b>:
                                                            {{ $product['item']['measure'] }}{{ $product['size'] }} <br>
                                                        @endif
                                    ...
                                    <div class="edit-account-info-div">
                                        <div class="form-group">
                                            <a class="back-btn"
                                                href="{{ route('user-orders') }}">{{ $langg->lang318 }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
