                        ...
                        <div class="order-details">
                            ...
                            <div class="view-order-page">
                                ...
                                <p class="order-date">{{ $langg->lang301 }}
                                    {{ date('d-M-Y', strtotime($subscribe->created_at)) }}
                                </p>
                                ...
                                <div class="shipping-add-area">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <p class="order-date">Start Date :
                                                {{ date('d-M-Y', strtotime($subscribe->start_date)) }} </p>
                                            <p class="order-date">End Trial Date :
                                                {{ date('d-M-Y', strtotime($subscribe->trial_end_date)) }} </p>
                                            <p class="order-date">End Date :
                                                {{ date('d-M-Y', strtotime($subscribe->end_date)) }} </p>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <address>
                                                    ...
                                                    {{ $order->customer_country }} - {{ $order->customer_city }} -
                                                    {{ $order->customer_zip }}
                                                </address>
                                            </div>
                                            <div class="col-md-6">
