            ...
            <div>
                <div class="settings-container">
                    <div class="settings-header d-flex justify-content-between align-items-center">
                        <h3>{{ $langg->lang378 }}</h3>
    					<a data-toggle="modal" data-target="#vendorform" class="btn btn-success" href="javascript:;"> <i class="fas fa-envelope"></i> {{ $langg->lang379 }}</a>
					</div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="contact-form">
                          <form id="emailreply1">
                                {{csrf_field()}}
                                <input type="text" class="input-field form-control mb-3" id="order" name="order_numkber" placeholder="{{ $langg->lang386 }} *" required="">
