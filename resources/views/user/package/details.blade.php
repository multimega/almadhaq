                                ...
                                @if (!empty($package))
                                    @if ($package->subscription_id != $subs->id)
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <span class="notic"><b>{{ $langg->lang415 }}</b>
                                                    {{ $langg->lang416 }}</span>
                                            </div>
                                        </div>
                                    ...
                                    @if ($subs->price != 0)
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <select name="method" id="option" onchange="meThods(this)"
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).on('submit', '#paystack-form', function(e) {
            var val = $('#sub').val();
            if (val == 0) {
                $.get('{{ route('user.paystack.check') . '?shop_name=' }}' + $('#shop-name').val(), function(data,
                    status) {
