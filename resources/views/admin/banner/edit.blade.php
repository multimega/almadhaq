                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-sb-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="left-area">
                          	...
                          	<div class="col-lg-7">
								<div class="text-editor">
									<textarea class="ckeditor" name="title">{{ $data->title }}</textarea>
								</div>
				      	</div>
                        </div>
                         ...
                         <div class="col-lg-7">
								<div class="text-editor">
									<textarea class="ckeditor" name="title_ar">{{ $data->title_ar }}</textarea>
								</div>
				      	</div>
                        </div>
                        ...
                        <div class="col-lg-7">
								<div class="text-editor">
									<textarea class="ckeditor" name="subtitle">{{ $data->subtitle }}</textarea>
								</div>
				      	</div>
                         ...
                         <div class="col-lg-7">
								<div class="text-editor">
									<textarea class="ckeditor" name="subtitle_ar">{{ $data->subtitle_ar }}</textarea>
								</div>
				      	</div>
                        </div>
                     ...
                     <div class="row">
                          ...
                          <div class="col-lg-7">
								<div class="text-editor">
									<textarea class="ckeditor" name="button">{{ $data->button }}</textarea>
								</div>
				      	</div>
                        </div>
                         ...
                         <div class="col-lg-7">
								<div class="text-editor">
									<textarea class="ckeditor" name="btn_ar">{{ $data->btn_ar }}</textarea>
								</div>
				      	</div>
                        </div>
