                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-sb-store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                         ...
                         <div class="col-lg-7">
								<div class="text-editor">
									<textarea class="ckeditor" name="title_ar"></textarea>
								</div>
				      	</div>
                        </div>
                        ...
                        <div class="col-lg-7">
								<div class="text-editor">
									<textarea class="ckeditor" name="subtitle"></textarea>
								</div>
				      	</div>
                         ...
                         <div class="col-lg-7">
								<div class="text-editor">
									<textarea class="ckeditor" name="subtitle_ar"></textarea>
								</div>
				      	</div>
                        </div>
                     ...
                     <div class="row">
                          ...
                          <div class="col-lg-7">
								<div class="text-editor">
									<textarea class="ckeditor" name="button"></textarea>
								</div>
				      	</div>
                        </div>
                         ...
                         <div class="col-lg-7">
								<div class="text-editor">
									<textarea class="ckeditor" name="btn_ar"></textarea>
								</div>
				      	</div>
                        </div>
