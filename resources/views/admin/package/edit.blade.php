                    ...
                    <div class="product-description">
                     ...
                     <div class="row">
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Arabic Subtitle') }} *</h4>
                                <p class="sub-heading">{{ __('(Arabic)') }}</p>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="subtitle_ar" placeholder="{{ __('Arabic Subtitle') }}" required="" value="{{ $data->subtitle_ar }}">
                          </div>
                        </div>
