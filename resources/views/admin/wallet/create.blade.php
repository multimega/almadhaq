                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-wallet-store')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                       ...
                       <div class="row">
                         ...
                         <div class="row">
                          ...
                          <div class="col-lg-6">
                            ...
                            <input type="number" class="input-field col-lg-5" name="refunds" min="0" placeholder="{{ __('Enter Refunds') }}" required="" value=""><span class="col-lg-1">$</span>
                          </div>
                        </div>
