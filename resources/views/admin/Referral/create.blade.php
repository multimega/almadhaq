                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-referral-store')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                       ...
                       <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <button class="addProductSubmit-btn" type="submit">{{ __('Create Code') }}</button>
                          </div>
                        </div>
                      </form>
                      </div>
