          ...
          <div class="body-area">
            ...
            <form id="geniusform" action="{{route('admin-lang-create')}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-lg-7">
                  <input type="text" class="input-field" name="sign" placeholder="{{ __('sign') }}" required=""
                    value="en">
                </div>
              </div>
                  ...
                  <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                      ...
                      <div class="row">
                       ...
                       <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang901" placeholder="PAGES" required="" value="PAGES">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang908" placeholder="PAGES" required="" value="PAGES">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang906" placeholder="About" required="" value="About">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang912" placeholder="About US" required="" value="About Us">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang907" placeholder="Features" required="" value="Features">
                          </div>
                        </div>
                         ...
                         <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang910" placeholder="Subscribe Message" required="" value="Subscribe Message">
                          </div>
                        </div>
                         ...
                         <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang900" placeholder="Shopping Cart" required="" value="Shopping Cart">
                          </div>
                        </div>
                         ...
                         <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang909" placeholder="Add To Compare" required="" value="Add To Compare">
                          </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang806" placeholder="Brands" required="" value="Brands">
                        </div>
                      </div>
 <div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang807" placeholder="All Notifications" required="" value="All Notifications">
                        </div>
                      </div>
<div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang808" placeholder="Notifications" required="" value="Notifications">
                        </div>
                      </div>
<div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang809" placeholder="Loyalty Program" required="" value="Loyalty Program">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang810" placeholder="Referrals program" required="" value="Referrals program">
                        </div>
                      </div>
 <div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang811" placeholder="Wallet" required="" value="Wallet">
                        </div>
                      </div>
 <div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang812" placeholder="Promo Codes" required="" value="Promo Codes">
                        </div>
                      </div>
<div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang813" placeholder="Address List" required="" value="Address List">
                        </div>
                      </div>
<div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang814" placeholder="Card Number" required="" value="Card Number">
                        </div>
                      </div>
<div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang815" placeholder="Discount off" required="" value="Discount off">
                        </div>
                      </div>
<div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang816" placeholder="Limited Purchase" required="" value="Limited Purchase">
                        </div>
                      </div>
<div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang817" placeholder="Exp" required="" value="Exp">
                        </div>
                      </div>
<div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang818" placeholder="Copy Code" required="" value="Copy Code">
                        </div>
                      </div>
<div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang819" placeholder="Use This Code To Buy One From This Product For Free" required="" value="Use This Code To Buy One From This Product For Free">
                        </div>
                      </div>
<div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang820" placeholder="points" required="" value="points">
                        </div>
                      </div>
<div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang821" placeholder="message" required="" value="message">
                        </div>
                      </div>
<div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang822" placeholder="Points For Copoun" required="" value="Points For Copoun">
                        </div>
                      </div>
<div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang823" placeholder="times to Use" required="" value="times to Use">
                        </div>
                      </div>
<div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang824" placeholder="Times" required="" value="Times">
                        </div>
                      </div>
<div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang825" placeholder="Referrals Code" required="" value="Referrals Code">
                        </div>
                      </div>
<div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang826" placeholder="Partners" required="" value="Partners">
                        </div>
                      </div>
<div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang827" placeholder="No Use Wallet" required="" value="No Use Wallet">
                        </div>
                      </div>
<div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang828" placeholder="Use Wallet" required="" value="Use Wallet">
                        </div>
                      </div>
<div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang829" placeholder="Shipment Price" required="" value="Shipment Price">
                        </div>
                      </div>
<div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang830" placeholder="Refelars Code To Get Points" required="" value="Refelars Code To Get Points">
                        </div>
                      </div>
