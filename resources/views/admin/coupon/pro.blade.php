												...
												<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
													<thead>
													 ...
													 <tbody>
													     ...
													     <td> <a href="javascript:;" data-href="{{route('admin-coupon-delete-pro',$p->id)}}" data-bs-toggle="modal" data-bs-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i></a></td>   
													     </tr>
