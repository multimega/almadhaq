					...
					<div class="table-responsiv">
						<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
							...
							<tbody>
								...
								@forelse($cats as $p)
								@php
								$product = App\Models\Category::where('id',$p->cat_id)->first();
								@endphp
								<tr>
									<td>{{!empty($product->name) ? $product->name : "product deleted"}}</td>


									<td> <a href="javascript:;" data-href="{{route('admin-coupon-delete-cat',$p->id)}}"
											data-bs-toggle="modal" data-bs-target="#confirm-delete" class="delete"><i
