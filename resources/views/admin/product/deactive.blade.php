...
<div class="content-area">
    <div class="home-head mb-4 mb-md-5">
        <h3>{{ __("Deactivated Products") }} <span>{{ __("Manage your deactivated products") }}</span></h3>
        <nav class="mt-3" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ __("Dashboard") }}</a></li>
                <li class="breadcrumb-item"><a href="{{ route('admin-prod-index') }}">{{ __("Products") }}</a></li>
                <li class="breadcrumb-item">{{ __("Deactivated Products") }}</li>
            </ol>
        </nav>
    </div>
...
<div class="modal fade" id="catalog-modal" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center">
                <button type="button" class="btn btn-default" data-bs-dismiss="modal">{{ __("Cancel") }}</button>
                <a class="btn btn-success">{{ __("Proceed") }}</a>
            </div>
        </div>
    </div>
</div>
