...
<div class="content-area">
    <div class="home-head mb-4 mb-md-5">
        <h3>{{ __("Product Bulk Upload") }} <span>Manage your product bulk upload</span></h3>
	...
	<div class="default-box">
		<div class="row">
			<div class="col-lg-12">
                ...
                <form id="geniusform" action="{{route('admin-prod-importsubmit')}}" method="POST" class="text-center" enctype="multipart/form-data">
                    {{csrf_field()}}
                    @include('includes.admin.form-both')  
                    <div class="text-end mb-3">
                        <a class="btn main-dark-btn bg-dark-opacity mb-2" href="{{asset('assets/test-products.xlsx')}}">{{ __("Download Sample Excal") }}</a>
                        <a class="btn main-dark-btn bg-green-opacity mb-2" href="{{ route('product.export') }}">Export Product Data</a>
                    </div>
				    <div class="csv-icon">
