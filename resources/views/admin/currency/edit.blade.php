                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-currency-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="name_ar" placeholder="{{ __('Enter Currency Arabic Name') }}" required="" value="{{$data->name_ar}}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            ...
                            @if(! empty($data->image))
                            <div class="col-lg-4">
                                <img src="{{asset('/assets/images/currency/'.$data->image)}}" width="50px" height="50px">
                            </div>
                            @endif
                        </div>
