                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-points-store')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                       ...
                       <div class="row">
                         ...
                         <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Points') }} *</h4>
                                <!--<p class="sub-heading">{{ __('(In Any Language)') }}</p>-->
                            </div>
                          </div>
                          <div class="col-lg-6">
                              
                            <input type="number" class="input-field col-lg-5" name="points" min="0" placeholder="{{ __('Enter Points') }}" required="" value="">
                          </div>
                        </div>
