...
@section('content')  
          ...
          <div class="content-area">
            <div class="mr-breadcrumb">
              <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Shipment Methods') }}</h4>
                    <ul class="links">
                      <li>
                      ...
                      <li>
                        <a href="{{ route('admin-shipment-index') }}">{{ __('Shipment Methods') }}</a>
                      </li>
                    </ul>
                </div>
              </div>
...
{{-- DATA TABLE --}}
    ...
    var table = $('#geniustable').DataTable({
         ordering: false,
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-shipment-datatables') }}',
               columns: [
                  { data: 'name', name: 'name' },
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
          '<a class="add-btn" data-href="{{route('admin-shipment-create')}}" id="add-data" data-bs-toggle="modal" data-bs-target="#modal1">'+
          '<i class="fas fa-plus"></i> {{ __('Add New Shipment Method') }}'+
          '</a>'+
          '</div>');
      });                     
