...
<form id="geniusformdata" action="{{route('admin-cat-create')}}" method="POST" enctype="multipart/form-data" class="inp-50">
    {{csrf_field()}}
    <div class="row">
        <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="title" placeholder="{{ __("English Title") }}"  value="">
        </div>
        <div class="col-md-6">
            <label>{{ __("Arabic Title") }}</label>
            <input type="text" class="form-control" name="title_ar" placeholder="{{ __("Arabic Title") }}"  value="">
        </div>
    </div> 
    <div class="row">
        <div class="col-md-12">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="text-editor">
                ...
                <textarea name="meta_description" class="ckeditor form-control" placeholder="{{ __("English Meta Description") }}"></textarea>
            </div>
        </div>
        <div class="col-md-6">
            <div class="text-editor">
    ...
    <div class="showbox">
        <div class="row">
            <div class="col-lg-12">
                <label>{{ __('Set Feature Image') }}</label>
                <div class="img-upload">
                    <div id="image-preview" class="img-preview" style="background: url({{ asset('assets/admin/images/upload.png') }});">
...
<script type="text/javascript">
 ...
 $('.tab-control').click(function(){
    if($(this).siblings(".shown-hidden-tab").is(":visible")){
        $(this).siblings('.shown-hidden-tab').slideUp();
    }else{
        $(this).siblings('.shown-hidden-tab').slideDown();
    }   
});
