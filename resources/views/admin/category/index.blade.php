  ...
  transform: rotate(45deg);
					...
					<div class="content-area">
					    <div class="home-head mb-4 mb-md-5">
                            <h3>{{ __("Main Categories") }} <span>{{ __("Manage your categories") }}</span></h3>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="main-dark-btn" data-href="{{route('admin-cat-create')}}" id="add-data"  data-bs-toggle="modal" data-bs-target="#modal1">'+
