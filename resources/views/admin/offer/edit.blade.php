...
@section('content')
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-offer-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="name_ar" placeholder="{{ __('Arabic Name') }}" value="{{$data->name_ar}}" required="">
                          </div>
                        </div>
   ...
   <div class="row">
                          ...
                          <div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="{{ __('Enter Offer Page Title') }}" value="{{ $data->title }}" name="title" >
													</div>
												</div>
												<div class="row">
													<div class="col-lg-4">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="{{ __('Enter Offer Page Arabic Title') }}"  value="{{ $data->title_ar }}" name="title_ar" >
													</div>
												</div>
