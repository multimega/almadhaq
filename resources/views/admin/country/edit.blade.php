                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-country-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="country_name" placeholder="{{ __('Enter name') }}" required="" value="{{$data->country_name}}">
                          </div>
                        </div> 
                    <!--    <div class="row">
                          <div class="col-lg-4">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="country_code" placeholder="{{ __('Enter Code') }}" required="" value="{{$data->country_code}}">
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-lg-4">
                    ...
                    <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="number" class="input-field" name="phone_numbers" placeholder="{{ __('Enter Phone Numbers') }}" value="{{$data->phone_numbers}}">
                          </div>
                        </div>
