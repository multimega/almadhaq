                ...
                <div class="col-md-6 offset-md-3">
                  ...
                  <form id="geniusform" action="{{route('admin-attr-update', $attr->id)}}" method="post" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                               <label for=""><strong>{{__('Arabic Name')}}</strong></label>
                               <div class="">
                                 <input type="text" class="input-field" name="name_ar" value="{{$attr->name_ar}}" placeholder="{{__('Enter Arabic Name')}}" required>
                               </div>
                               @if ($errors->has('name_ar'))
                                 <p class="text-danger mb-0">{{$errors->first('name_ar')}}</p>
                               @endif
                          </div>
                        </div>
                      </div>
                          ...
                          <div class="form-group">
                               ...
                               <div class="row mb-2 counterrow" v-for="option in options" :key="option.id">
                                 <div class="col-md-11">
                                   ...
                                   <input class="input-field optionin" type="text" name="optionsa[]" :value="option.name_ar" placeholder="{{__('Arabic Option label')}}" required>
                                 </div>
                               ...
                               <div class="row mb-2 counterrow" v-for="n in counter" :id="'newOption'+n">
                                 <div class="col-md-11">
                                   ...
                                   <input class="input-field optionin" type="text" name="optionsa[]" value="" placeholder="{{__('Arabic Option label')}}" required>
                                 </div>
