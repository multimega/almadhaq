                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-coupon-update-piece',$data->id)}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                 ...
                 <!--       <div class="row">
                       ...
                       <!-- <div class="row hidden">
                        ...
                        <div class="row hidden">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="buy" placeholder="{{ __('Enter Number') }}"  value="{{$data->buy}}">
                          </div>
                        </div>     
                        <div class="row">
                          <div class="col-lg-4">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="take" placeholder="{{ __('Enter Number') }}"  value="{{$data->take}}">
                          </div>
                        </div>
                       <div class="row">
                          <div class="col-lg-4">
