...
<form id="geniusformdata" action="{{route('admin-childcat-create')}}" method="POST" enctype="multipart/form-data" class="inp-50">
    {{csrf_field()}}
    <div class="row">
        <div class="col-lg-12">
    ...
    <div class="row">
      <div class="col-lg-12">
          ...
          <select id="subcat" name="subcategory_id" class="form-select" required="" disabled=""></select>
      </div>
    </div>
    <div class="row">
        <div class="col-md-6">
