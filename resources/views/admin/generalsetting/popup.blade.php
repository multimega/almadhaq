                    ...
                    <div class="product-description">
                      <div class="body-area">
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Popup Title') }}" name="popup_title" value="{{ $gs->popup_title }}" >
                          </div>
                        </div>
                          ...
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Popup Arabic Title') }}" name="popup_title_ar" value="{{ $gs->popup_title_ar }}" >
                          </div>
                        </div>
                          ...
                          <div class="row justify-content-center">
                            ...
                            <div class="row justify-content-center">
                              <div class="col-lg-3">
                                <div class="left-area">
                                  <h4 class="heading">
                                      {{ __('Popup Arabic Text') }} *
                                  </h4>
                                </div>
                              </div>
                              <div class="col-lg-6">
                                  <div class="tawk-area">
                                    <textarea class="input-field"  name="popup_text_ar" placeholder="{{ __('Popup Text') }}">{{$gs->popup_text_ar}}</textarea>
                                  </div>
                              </div>
                            </div>
