                        ...
                        @include('includes.admin.form-both')  
                          ...
                          <div class="row justify-content-center">
                           ...
                           <div class="row justify-content-center">
                              ...
                              <div class="col-lg-6">
                                  <div class="tawk-area">
                                    <input type="text" class="input-field"  name="messagee" value="{{ $gs->messagee }}">
                                  </div>
                              </div>
                            </div>
                              ...
                              <div class="col-lg-3">
                                <div class="left-area">
                                  <h4 class="heading">
                                      Arabic ِMessage Header
                                  </h4>
                                </div>
                              </div>
                              <div class="col-lg-6">
                                  <div class="tawk-area">
                                    <input type="text" class="input-field"  name="messagee_ar" value="{{ $gs->messagee_ar }}">
                                  </div>
                              </div>
                            </div>
                        <div class="row justify-content-center">
