...
<div class="content-area">
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">{{ __('Fatora settings') }}</h4>
                    <ul class="links">
                      <li>
                      ...
                      <li>
                        <a href="javascript:;">{{ __('Fatora settings') }}</a>
                      </li>
                    ...
                    <div class="product-description">
                      <div class="body-area">
                       ...
                       <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Fatora Token ') }} *
                                  </h4>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <input type="text" class="input-field" name="fatoratoken"value="{{ $gs->fatoratoken }}" required="">
                          </div>
                        </div>
