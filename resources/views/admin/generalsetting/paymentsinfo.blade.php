                    ...
                    <div class="product-description">
                      <div class="body-area">
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Fawry Cancel  url') }} *
                                  </h4>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <input type="text" class="input-field"  name="cancel_url" value="{{ $gs->cancel_url }}" required="">
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Fawry Secret') }} *
                                  </h4>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <input type="text" class="input-field"   name="fawry_secret" value="{{ $gs->fawry_secret }}" required="">
                          </div>
                        </div>
...
<hr>
                      ...
                      <hr>
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Free Shipping') }} *
                                  </h4>
                                  <p class="sub-heading">{{ __('Free shipping after total price more than this value') }}</p>
                                 
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Free Shipping') }}" name="free_shipping" value="{{ $gs->free_shipping }}" required="">
                          </div>
                        </div>
