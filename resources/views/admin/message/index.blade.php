...
<div class="content-area">
  <div class="home-head mb-4 mb-md-5">
    <h3>{{ __("Tickets") }} <span>Manage your tickets</span></h3>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p class="text-center">{{ __('You are about to delete this Ticket. Every messages under this Ticket will be
          deleted.') }}</p>
              ...
              <div class="col-md-12">
                <div class="contact-form">
                  <form id="emailreply1" class="exp-form">
                    {{csrf_field()}}
                    <input type="email" class="form-control mb-3 eml-val" id="eml1" name="to"
                      placeholder="{{ __('Email') }} *" value="" required="">
                    <input type="text" class="form-control mb-3" id="subj1" name="subject"
                      placeholder="{{ __('Subject') }} *" required="">
                    <textarea class="form-control textarea mb-3" name="message" id="msg1"
...
<script type="text/javascript">
  var table = $('#geniustable').DataTable({
        ...
        $(".btn-area").append('<div class="col-sm-4 text-end">'+
          '<a class="main-dark-btn" href="javascript:;" data-bs-toggle="modal" data-bs-target="#vendorform"><i class="fas fa-envelope"></i> {{ __('Add Ticket') }}</a>'+'</div>');
      });                       
