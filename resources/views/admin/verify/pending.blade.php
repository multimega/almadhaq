...
@section('content')  
					...
					<div class="content-area">
					    <div class="home-head mb-4 mb-md-5">
                            <h3>{{ __("Pending Verifications") }} </h3>
                            <nav class="mt-3" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ __("Dashboard") }}</a></li>
                                    <li class="breadcrumb-item"><a href="javascript:;">{{ __('Vendor Verifications') }}</a></li>
                                    <li class="breadcrumb-item"><a href="{{ route('admin-vr-index') }}">{{ __("Pending Verifications") }}</a></li>
                                </ol>
                            </nav>
                        </div>
