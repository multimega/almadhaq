...
<div class="content-area">
	<div class="home-head mb-4 mb-md-5">
        <h3>{{ __("Vendor Details") }} <span>{{ __("Manage your vendors") }}</span></h3>
    ...
    <div class="add-product-content customar-details-area default-box">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="user-image">
                        ...
                        @endif
                        <a href="javascript:;" class="main-dark-btn my-3 data-email="{{ $data->email }}" data-bs-toggle="modal" data-bs-target="#vendorform">{{ __("Send Message") }}</a>
                    </div>
                </div>
                <div class="col-md-4">
                    ...
                    <div class="table-responsive show-table">
                        ...
                        <tr>
                            <td>
                                    ...
                                    @else 
                                    <a class="badge badge-danger verify-link" href="javascript:;">{{ __("Unverified") }}</a>
                                    @endif
                            </td>
                            <td>
                            </td>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="contact-form">
                                    <form id="emailreply1" class='form-exp'>
                                        {{csrf_field()}}
