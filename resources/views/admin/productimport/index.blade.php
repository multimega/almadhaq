...
<div class="content-area">
    <div class="home-head mb-4 mb-md-5">
        <h3>{{ __("Affiliate Products") }} <span>Manage your affiliate products</span></h3>
        <nav class="mt-3" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ __("Dashboard") }}</a></li>
				<li class="breadcrumb-item"><a href="{{ route('admin-prod-index') }}"> {{ __('Products') }}</a></li>
                <li class="breadcrumb-item">{{ __("Affiliate Products") }}</li>
            </ol>
        </nav>
    </div>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="main-dark-btn" href="{{route('admin-import-create')}}">'+
