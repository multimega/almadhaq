...
@section('content')  
<input type="hidden" id="headerdata" value="{{ __('Affiliate Cats') }}">
    ...
    <div class="home-head mb-4 mb-md-5">
        ...
        <nav class="mt-3" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">{{ __("Affiliate Categories") }}</li>
            </ol>
        </nav>
    </div>
    @include('includes.admin.navs.affiliates_nav')
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route("admin-affiliate-settings-datatables") }}',
               columns: [
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="main-dark-btn" href="{{route('admin-affilate-settings-create')}}">'+
          '<i class="fas fa-plus"></i> <span class="remove-mobile">{{ __("Add New Affiliate category") }}<span>'+
          '</a>'+
          '</div>');
      });											
