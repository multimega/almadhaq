                ...
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="name_ar" placeholder="{{ __('Enter Arabic name') }}"  value="{{$data->name_ar}}">
                          </div>
                        </div> 
                         ...
                         <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">امكانية الدفع كاش</h4>
                            </div>
                          </div>
                          <div class="col-lg-7">
                              <div class="text-right">
  <input class="form-check-input" type="checkbox" name="allow_cash" {{ $data->allow_cash=="on" ? "checked":"" }} id="allow_cash">
</div>
                          </div>
                        </div>
