...
<div class="content-area">
    <div class="home-head mb-4 mb-md-5">
        <h3>{{ __("Users Bulk Upload") }} <span>Manage your users bulk upload</span></h3>
        <nav class="mt-3" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ __("Dashboard") }}</a></li>
                <li class="breadcrumb-item"><a href="{{ route('admin-user-index') }}">{{ __("All user") }}</a></li>
    ...
    <div class="default-box">
        <div class="row">
            <div class="col-lg-12">
                ...
                <form id="geniusform" action="{{route('admin-user-importsubmit')}}" method="POST" class="text-center" enctype="multipart/form-data">
                    {{csrf_field()}}
                    @include('includes.admin.form-both')  
                    <div class="text-end mb-3">
                        <a class="btn main-dark-btn bg-dark-opacity mb-2" href="{{asset('assets/test-user.xlsx')}}">{{ __("Download Sample Excal") }}</a></span>
                        <a class="btn main-dark-btn bg-green-opacity mb-2" href="{{ route('user.export') }}">Export User Data</a>
                    </div>
					<div class="csv-icon">
