                                                ...
                                                <tbody>
                                                    @foreach ($data->orders as $order)
                                                        <tr>
                                                            ...
                                                            <td>{{ date('Y-m-d h:i:s a', strtotime($order->created_at)) }}
                                                            </td>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="contact-form">
                                        <form id="emailreply1">
                                            {{ csrf_field() }}
                                            <input type="email" class="form-control mb-3 eml-val" id="eml1"
                                                name="to" placeholder="{{ __('Email') }} *" value=""
                                                required="">
                                            <input type="text" class="form-control mb-3" id="subj1" name="subject"
                                                placeholder="{{ __('Subject') }} *" required="">
                                            <textarea class="form-control mb-3 textarea" name="message" id="msg1" placeholder="{{ __('Your Message') }} *"
                                                required=""></textarea>
                                            <button class="main-dark-btn" id="emlsub1"
