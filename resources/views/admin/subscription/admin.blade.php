...
-->
	...
	@if(DB::table('admin_languages')->where('is_default','=',1)->first()->rtl == 1)
     ...
     @if($gs->light_dark == 1)
		...
		<link href="{{asset('assets/admin/rtl/light/style.css')}}" rel="stylesheet"/>
				<link href="{{asset('assets/admin/css/rtl/customs.css')}}" rel="stylesheet"/>
		<link href="{{asset('assets/admin/rtl/light/responsive.css')}}" rel="stylesheet" />
		@else
...
@else
       ...
       <link href="{{asset('assets/admin/css/light/style.css')}}" rel="stylesheet"/>
       <link href="{{asset('assets/admin/css/light/style_lite.css')}}" rel="stylesheet"/>
		...
		<link href="{{asset('assets/admin/css/light/responsive.css')}}" rel="stylesheet" />
						...
						<div class="d-flex justify-content-between">
							...
							<div class="right-eliment">
								<ul class="list">
									...
									<li class="bell-area">
									 @if($gs->light_dark == 0)   
									<a id="notf_conv" class="dropdown-toggle-1" data-toggle="tooltip" title="Go To light"  href="{{ route('admin.mode',1) }}">
										<i class="fas fa-sun"></i>
									</a>
                                    @else
                                    	<a id="notf_conv" class="dropdown-toggle-1" data-toggle="tooltip" title="Go To Dark"   href="{{ route('admin.mode',0) }}">
									...
									<a id="notf_conv" class="dropdown-toggle-1" target="_blank" href="{{ route('front.index',$l->id == 1 ? "en" : "ar") }}">
