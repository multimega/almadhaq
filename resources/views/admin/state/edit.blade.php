                    ...
                    <div class="product-description">
                      ...
                      <div class="row">
                          ...
                          <div class="col-lg-7">
                               ...
                               @foreach (DB::table('zone')->get() as $dat)
                            	<option value="{{ $dat->id}}" {{$data->state_id == $dat->id ? "selected" : "" }} >{{ $dat->name }}</option>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="name_ar" placeholder="{{ __('Enter ِArabic name') }}"  value="{{$data->name_ar}}">
                          </div>
                        </div>
                    <!--    <div class="row">
                          <div class="col-lg-4">
