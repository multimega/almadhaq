                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-pointss-create')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="row hidden">
                         ...
                         <div class="row">
                          ...
                          <div class="col-lg-6">
                            ...
                            <input type="text" class="input-field col-lg-5" name="limited" placeholder="{{ __('Enter Limited') }}" required="" value="">
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-lg-4">
                          ...
                          <div class="col-lg-6">
                            ...
                            <input type="text" class="input-field col-lg-5" name="points" placeholder="{{ __('Enter Points') }}" required="" value="">
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-lg-4">
                          ...
                          <div class="col-lg-7">
                            <input type="number" class="input-field" name="days"  placeholder="{{ __('enter Days') }}" required="" value="">
                          </div>
                        </div>
