                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-points-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="row hidden">
                         ...
                         <div class="row">
                          ...
                          <div class="col-lg-6">
                            ...
                            <input type="text" class="input-field col-lg-5" name="limited" placeholder="{{ __('Enter Limited') }}" required="" value="{{$data->limited}}">
                          </div>
                        </div>   
                        <div class="row">
                          <div class="col-lg-4">
                         ...
                         <div class="row">
                                      ...
                                      <div class="col-lg-7">
                                        <div class="img-upload">
                                            <div id="image-preview" class="img-preview" style="background: url({{ $data->photo ? asset('assets/images/points/'.$data->photo):asset('assets/images/noimage.png') }});">
