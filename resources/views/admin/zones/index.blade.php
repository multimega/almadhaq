            ...
            <div class="product-area">
              ...
              <div class="heading-area">
                                 ...
                                 <!--     <select class="process select droplinks {{ $gs->shipment == 1 ? 'drop-success' : 'drop-danger' }}">
                                      ...
                                      <a class="add-btn " data-href="{{route('admin-city-zone-create')}}" id="add-data" data-bs-toggle="modal" data-bs-target="#modal1">
...
{{-- DATA TABLE --}}
    ...
    var table = $('#geniustable').DataTable({
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
          '<a class="add-btn" data-href="{{route('admin-zones-create')}}" id="add-data" data-bs-toggle="modal" data-bs-target="#modal1">'+
