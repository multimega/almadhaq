              ...
              <div class="add-product-content">
                      ...
                      @include('includes.admin.form-both') 
                                      ...
                                      <div class="panel panel-default slider-panel">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <textarea class="form-control" name="title_text_ar" id="title_text" rows="5"  placeholder="{{ __('Enter Arabic Title Text') }}"></textarea>
                                                </div>
                                              </div>
                                      ...
                                      <div class="panel panel-default slider-panel">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <textarea class="form-control" name="details_text_ar" id="details_text" rows="5"  placeholder="{{ __('Enter Arabic Title Text') }}"></textarea>
                                                </div>
                                              </div>
                ...
                @endif
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="btn_text" placeholder="{{ __('button Name') }}" required="" value="">
                          </div>
                        </div>
             <div class="row">
                          <div class="col-lg-4">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="btn_text_ar" placeholder="{{ __('button Arabic Name') }}" required="" value="">
                          </div>
                        </div>
