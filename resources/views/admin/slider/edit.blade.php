...
@section('content')
                ...
                <div class="row">
                  <div class="col-lg-12">
                      ...
                      @include('includes.admin.form-both') 
                                      ...
                                      <div class="panel panel-default slider-panel">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <textarea class="form-control" name="title_text_ar" id="title_text" rows="5"  placeholder="{{ __('Enter Arabic Title Text') }}">{{$data->title_text_ar}}</textarea>
                                                </div>
                                              </div>
                                      ...
                                      <div class="panel panel-default slider-panel">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <textarea class="form-control" name="details_text_ar" id="details_text" rows="5"  placeholder="Enter Arabic Title Text">{{$data->details_text_ar}}</textarea>
                                                </div>
                                              </div>
                        ...
                        <div class="row">
                          ...
                          @if($gs->templatee_select == 17) 
                         <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">{{ __('FIRST SIDE PHOTO') }} *</h4>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <div class="img-upload full-width-img">
                                <div id="image-preview" class="img-preview" style="background: url({{ $data->first_side_photo ? asset('assets/images/sliders/'.$data->first_side_photo):asset('assets/images/noimage.png') }});">
                                    <label for="image-upload2" class="img-label" id="image-label2"><i class="icofont-upload-alt"></i>{{ __('Upload Image') }}</label>
                                    <input type="file" name="first_side_photo" class="img-upload" id="image-upload2">
                                  </div>
                                  <p class="text"></p>
                            </div>
                    ...
                    <br><br>
                          ...
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">{{ __('SECOND SIDE PHOTO') }} *</h4>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <div class="img-upload full-width-img">
                                <div id="image-preview" class="img-preview" style="background: url({{ $data->second_side_photo ? asset('assets/images/sliders/'.$data->second_side_photo):asset('assets/images/noimage.png') }});">
                                    <label for="image-upload3" class="img-label" id="image-label3"><i class="icofont-upload-alt"></i>{{ __('Upload Image') }}</label>
                                    <input type="file" name="second_side_photo" class="img-upload" id="image-upload3">
                                  </div>
                                  <p class="text"></p>
                            </div>
    ...
    <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="btn_text" placeholder="{{ __('button Name') }}" required="" value="{{$data->btn_text}}">
                          </div>
                        </div>
             <div class="row">
                          <div class="col-lg-4">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="btn_text_ar" placeholder="{{ __('button Arabic Name') }}" required="" value="{{$data->btn_text_ar}}">
                          </div>
                        </div>
