                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="10%">:</td>
                                        <td width="45%">
                                            {{ $order->currency_sign }}{{ round($order->pay_amount, 2) * $order->currency_value }}
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="45%">
                                            <div class="editable-field" data-field="order_note"
                                                ...
                                                <span
                                                    class="display-value">{{ $order->order_note ?: __('No note provided') }}</span>
                                                <div class="edit-form" style="display: none;">
                                                    <textarea class="edit-textarea" rows="3">{{ $order->order_note }}</textarea>
                                                    <div class="edit-buttons">
                                                        <button
                                                            class="btn btn-success btn-sm save-btn">{{ __('Save') }}</button>
                                                        <button
                                                            class="btn btn-secondary btn-sm cancel-btn">{{ __('Cancel') }}</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="45%">
                                            <div class="editable-field" data-field="customer_address"
                                                ...
                                                <span
                                                    class="display-value">{{ $order->customer_address ?: __('No address provided') }}</span>
                                                <div class="edit-form" style="display: none;">
                                                    <textarea class="edit-textarea" rows="3">{{ $order->customer_address ?? '' }}</textarea>
                                                    <div class="edit-buttons">
                                                        <button
                                                            class="btn btn-success btn-sm save-btn">{{ __('Save') }}</button>
                                                        <button
                                    ...
                                    <tbody>
                                        ...
                                        @if ($order->shipment_id == 1 && $order->status == 'processing')
                                            <tr>
                                                ...
                                                <td width="45%"><a
                                                        href="{{ route('admin-order-fastlooshow', $order->company_fastlo_api) }}">{{ $order->company_fastlo_api }}
                                                </td>
                                        ...
                                        @if ($order->shipment_id == 7 && $order->status == 'processing')
                                            <tr>
                                                ...
                                                <th width="10%">:</th>
                                                <td width="45%"><a class="btn btn-success"
                                                        href="{{ route('admin-order-mylerz', $order->barcod) }}">{{ $order->barcod }}</a>
                                                </td>
                                                <td width="45%"><a class="btn btn-success"
                                        ...
                                        @if ($order->shipment_id == 2 && $order->status == 'processing')
                                            <tr>
                                                ...
                                                <th width="10%">:</th>
                                                <td width="45%"><a
                                                        href="{{ url('aramexdetailz/' . $order->aramex_api_numbeer) }}">{{ $order->aramex_api_numbeer }}</a>
                                                </td>
                                        ...
                                        @if ($order->shipment_id == 2 && $order->status == 'on delivery')
                                            <tr>
                                                ...
                                                <th width="10%">:</th>
                                                <td width="45%"><a
                                                        href="{{ route('tracks_aramexx', $order->pickuptrack_api) }}">{{ $order->pickuptrack_api }}</a>
                                                    <a class="btn btn-success"
                                        ...
                                        @if ($order->shipment_id == 4 && $order->status == 'processing')
                                            <tr>
                                                ...
                                                <th width="10%">:</th>
                                                <td><a class="btn sendEmail"
                                                        href="{{ route('admin-order', $order->serial) }}">
                                                        Status</a></td>
                                                &nbsp;&nbsp;
                                        ...
                                        @if ($order->shipment_id == 4 && $order->status == 'on delivery')
                                            ...
                                            <tr>
                                                ...
                                                <th width="10%">:</th>
                                                <td width="45%"><a
                                                        class="btn btn-success">{{ $order->fedex_pic_api }}</a></td>
                                        ...
                                        @if ($order->shipment_id == 6 && $order->status == 'on delivery')
                                            <tr>
                                                ...
                                                <th width="10%">:</th>
                                                <td width="45%"><a
                                                        class="btn btn-success">{{ $order->pickup_id }}</a>
                                                </td>
                                            </tr>
                                        @endif
                                            ...
                                            <tr>
                                                ...
                                                <td width="45%">
                                                    <div class="editable-field" data-field="shipping_address"
                                                        ...
                                                        <div class="edit-form" style="display: none;">
                                                            <textarea class="edit-textarea" rows="3">{{ $order->shipping_address ?: ($order->customer_address ?: '') }}</textarea>
                                                            <div class="edit-buttons">
                                                                <button
                                                                    class="btn btn-success btn-sm save-btn">{{ __('Save') }}</button>
                                                                <button
                                            ...
                                            <td>
                                                @if ($product['item']['user_id'] != 0)
                                                    ...
                                                    @if ($order->dp == 1 && $order->payment_status == 'Completed')
                                                        <span
                                                            class="badge bg-success py-2 ms-2">{{ __('Completed') }}</span>
                                                    @else
                                                        @if ($user->status == 'pending')
                                                            <span
                                                                class="badge bg-warning py-2 ms-2">{{ ucwords($user->status) }}</span>
                                                        @elseif($user->status == 'processing')
                                                            <span
                                                                class="badge bg-info py-2 ms-2">{{ ucwords($user->status) }}</span>
                                                        @elseif($user->status == 'on delivery')
                                                            <span
                                                                class="badge bg-primary py-2 ms-2">{{ ucwords($user->status) }}</span>
                                                        @elseif($user->status == 'completed')
                                                            <span
                                                                class="badge bg-success py-2 ms-2">{{ ucwords($user->status) }}</span>
                                                        @elseif($user->status == 'declined')
                                                            <span
                                                                class="badge bg-danger py-2 ms-2">{{ ucwords($user->status) }}</span>
                                                        @endif
                                                    @endif
                                                @endif
                                            </td>
                                                ...
                                                @if ($product['item']['user_id'] != 0)
                                                    ...
                                                    @if (isset($user))
                                                        <a target="_blank"
                                                            ...
                                                            {{ strlen($product['item']['name']) > 30
                                                                ? substr($product['item']['name'], 0, 30) . '...'
                                                                : $product['item']['name'] }}
                                                        </a>
                                                    @else
                                                        <a target="_blank"
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            if (!newValue) {
                                if (field === 'customer_address' || field ===
                                    'shipping_address') {
                            ...
                            $.notify(response.message || '{{ __('Error updating field') }}',
                                'error');
                        }
                    },
                    error: function(xhr) {
