                                    ...
                                    <div class="special-box">
                                        ...
                                        <div class="table-responsive-sm">
                                            <table class="table">
                                                <tbody>
                                                 <tr>
                                                    <th width="45%">Tracks Key</th>
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{$m['TrackingResults'][0]['Key']}}</td>
                                                </tr>
                                                 <tr>
                                                    <th width="45%">Updatee Code</th>
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{$m['TrackingResults'][0]['Value'][0]['UpdateCode']}}</td>
                                                </tr>
                                                 <tr>
                                                    <th width="45%">Update Description</th>
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{$m['TrackingResults'][0]['Value'][0]['UpdateDescription']}}</td>
