                    ...
                    <div class="content-area">
                        ...
                        <div class="mr-breadcrumb">
                            <div class="home-head mb-4 mb-md-5">
                                <h3>{{ __('Processing Orders') }}<span> {{ __('Manage your orders') }}</span></h3>
                                <nav class="mt-3" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ __("Dashboard") }}</a></li>
                                        <li class="breadcrumb-item"><a href="{{route('admin-order-index')}}">{{ __('Orders') }}</a></li>
                                        <li class="breadcrumb-item"><a href="{{ route('admin-order-processing') }}">{{ __('Processing Orders') }}</a></li>
                                    </ol>
                                </nav>
                            </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="vendorformLabel">{{ __('Send Email') }}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" style="opacity: 1; filter: invert(1);"></button>
                </div>
            <div class="modal-body">
