...
<div class="content-area">
    <div class="home-head mb-4 mb-md-5">
        <h3>{{ __("Orders Bulk Upload") }} <span>Manage your orders bulk upload</span></h3>
    ...
    <div class="default-box">
        <div class="row">
            <div class="col-lg-12">
                ...
                <form id="geniusform" action="{{route('order.import')}}" method="POST" class="text-center" enctype="multipart/form-data">
                    {{csrf_field()}}
                    @include('includes.admin.form-both')  
                    <div class="text-end mb-3">
                        <a class="btn main-dark-btn bg-dark-opacity mb-2" href="{{asset('assets/test-order.xlsx')}}">{{ __("Download Sample Excal") }}</a></span>
                        <a class="btn main-dark-btn bg-green-opacity mb-2" href="{{ route('order.export') }}">Export Order Data</a>
                        <a class="btn main-dark-btn bg-green-opacity mb-2" href="{{ route('order.export2') }}">Export  Order transfer</a>
                    </div>
                    <div class="csv-icon">
