                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-subscribes-create')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                       ...
                       <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field less-width" name="package_price" placeholder="" required="" value="">
                          </div>
                        </div>
                        ...
                        <div class="row ">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field less-width" name="paid_via" placeholder="{{ __('Enter paid via') }}" value=""><span></span>
                          </div>
                        </div>
                        ...
                        <div class="row ">
                          ...
                          <div class="col-lg-7">
                            ...
                            <textarea type="text" class="nic-edit-p" name="package_details" placeholder="{{ __('Enter package details') }}" value=""></textarea>
                             </div>
                          </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <button class="addProductSubmit-btn" type="submit">{{ __('Create Subscribe') }}</button>
                          </div>
                        </div>
                      </form>
                      </div>
